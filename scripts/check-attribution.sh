...
require_text NOTICE "Canonical source: https://github.com/mobazha/mobazha-unified"
require_text NOTICE "Copyright (c) 2026 fengzie and the respective contributors."
require_text NOTICE "THIRD_PARTY_NOTICES.md"
require_text THIRD_PARTY_NOTICES.md "OpenPGP.js"
require_text THIRD_PARTY_NOTICES.md "rpc-websockets"
require_text README.md "https://github.com/fengzie"
require_text README.md "https://github.com/mobazha/mobazha-unified"
...
while IFS= read -r file; do
  ...
  case "$file" in
    vendor/*|third_party/*|public/vendor/*)
      continue
      ;;
  esac

  case "$file" in
    *.js|*.jsx|*.ts|*.tsx|*.mjs|*.cjs|*.sh|*.py)
      ;;
    *)
      continue
      ;;
