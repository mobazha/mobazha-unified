...
import { ordersBackPath, parseOrderDetailRole } from '@/lib/ordersNavigation';
...
function OrderDetailPageContent() {
  ...
  const viewingContext = parseOrderDetailRole(searchParams);
  const listBackPath = ordersBackPath(searchParams, viewingContext);
