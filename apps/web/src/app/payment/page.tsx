...
import type { PaymentStep, ExternalWalletPaymentInfo } from '@/components/Payment';
...
export default function PaymentPage() {
  ...
  const visibleFiatProvider: string | undefined = undefined;
  ...
  // Execute Community Edition crypto payment.
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Mobile Bottom Bar (Community Edition crypto only) */}
