...
import { getSocialUsername } from '@mobazha/core';
                          ...
                          <HStack justify="between" align="center" className="mb-2">
                            ...
                            <HStack gap="xs">
                              {[...Array(5)].map((_, i) => (
                                <svg
                                  key={i}
                                  className={`w-4 h-4 ${i < review.rating ? 'text-warning' : 'text-muted-foreground/40'}`}
                                  fill="currentColor"
                                  viewBox="0 0 20 20"
                                >
              ...
              {moderator.contactInfo && (
                <Card>
                  ...
                  <VStack gap="md">
                    ...
                    {getSocialUsername(moderator.contactInfo.social, 'twitter') && (
                      <HStack gap="sm" align="center">
                        <svg
                          className="w-5 h-5 text-muted-foreground"
                          fill="currentColor"
                    ...
                    {getSocialUsername(moderator.contactInfo.social, 'telegram') && (
                      <HStack gap="sm" align="center">
                        <svg
                          className="w-5 h-5 text-muted-foreground"
                          fill="currentColor"
