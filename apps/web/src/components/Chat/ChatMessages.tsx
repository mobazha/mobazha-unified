    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex items-center gap-3 p-4 bg-card border-b border-border">
        {onBack && (
          <button
            onClick={onBack}
            className="lg:hidden p-2 -ml-2 hover:bg-surface-hover rounded-lg"
          >
          ...
          <VStack gap="md">
            ...
            {isEncrypted && (
              <div className="text-center py-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-emerald-500/20 text-emerald-600 rounded-full">
              ...
              return (
                <div key={message.id} className={`flex gap-2 ${isOwn ? 'flex-row-reverse' : ''}`}>
                  ...
                  <div className={`max-w-[70%] ${isOwn ? 'items-end' : 'items-start'}`}>
                    ...
                    <HStack
                      gap="xs"
                      className={`mt-1 text-xs text-muted-foreground ${isOwn ? 'justify-end' : ''}`}
                    >
        ...
        <HStack gap="sm">
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2 bg-muted rounded-full border-none focus:outline-none focus:ring-2 focus:ring-emerald-500 text-foreground placeholder:text-muted-foreground"
            />
          </div>
