        ...
        <Card data-testid="payment-refund-destination">
          <CardContent className={padding}>
            <RefundDestinationAddressDisplay
              address={trimmedResolved ?? ''}
              titleAs="h2"
              copyTestId="payment-refund-destination-copy"
              addressTestId="payment-refund-destination-address"
            />
          </CardContent>
        </Card>
      )}
          ...
          {showConfirmNotice && (
            ...
            >
              <div className="rounded-lg border border-border bg-muted/30 px-3 py-3 space-y-3">
                ...
                <RefundDestinationAddressDisplay
                  address={trimmedRefund}
                  showHeader={false}
                  copyTestId="payment-custodial-refund-confirm-copy"
                  addressTestId="payment-custodial-refund-confirm-address"
                />
                <button
                  type="button"
