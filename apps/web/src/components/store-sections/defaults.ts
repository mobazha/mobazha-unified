...
export const STORE_PRESETS: StorePreset[] = [
    ...
    config: {
      ...
      sections: [
        ...
        },
        {
          id: 'ocean-featured',
          type: 'featured-products',
          props: { title: 'Staff Picks', mode: 'newest', count: 3, columns: 3 },
          visible: true,
        },
        {
          id: 'ocean-about',
  ...
  },
  {
    id: 'electronics',
    name: 'Tech & Gadgets',
    nameKey: 'admin.storeBranding.presetElectronics',
    description: 'Bold, spec-forward layout for electronics and hardware',
    descriptionKey: 'admin.storeBranding.presetElectronicsDesc',
    config: {
      version: 1,
      status: 'published',
      theme: {
      ...
      sections: [
        {
          id: 'electronics-announce',
          type: 'announcement-bar',
          props: { text: 'Free shipping on orders over $99', dismissible: true },
          visible: true,
        },
        {
          id: 'electronics-hero',
          type: 'hero',
          props: {
            title: 'Gear That Performs',
            subtitle: 'Hand-tested hardware, transparent specs, crypto checkout',
        ...
        },
        {
          ...
          type: 'featured-products',
          props: { title: 'New Arrivals', mode: 'newest', count: 8, columns: 4 },
          visible: true,
        },
        {
          id: 'electronics-trust',
          type: 'trust-badges',
          props: { badges: [...WEB3_TRUST_KIT], layout: 'horizontal', style: 'minimal' },
          visible: true,
        },
        {
          id: 'electronics-faq',
          ...
          props: {
            ...
            items: [
              {
                question: 'Do products ship internationally?',
                answer: 'Yes — see each listing for regions and rates.',
              },
              {
                question: 'What is your warranty policy?',
                answer: 'All hardware includes a 12-month replacement warranty.',
              },
            ],
          },
          visible: true,
  ...
  },
  {
    id: 'collectibles',
    name: 'Collectibles',
    nameKey: 'admin.storeBranding.presetCollectibles',
    description: 'Showcase-first layout for cards, figures and rare finds',
    descriptionKey: 'admin.storeBranding.presetCollectiblesDesc',
    config: {
      version: 1,
      status: 'published',
      theme: {
      ...
      sections: [
        {
          id: 'collectibles-hero',
          type: 'hero',
          props: {
            title: 'The Vault',
            subtitle: 'Graded cards, limited runs and one-of-one finds',
        ...
        {
          id: 'collectibles-featured',
          type: 'featured-products',
          props: { title: 'Showcase', mode: 'newest', count: 6, columns: 3 },
          visible: true,
        },
        {
          id: 'collectibles-collections',
          type: 'collections',
          props: { title: 'Browse by Set', mode: 'all', layout: 'carousel' },
          visible: true,
        },
        {
          id: 'collectibles-trust',
          type: 'trust-badges',
          props: { badges: [...WEB3_TRUST_KIT], layout: 'grid', style: 'illustrated' },
          visible: true,
        },
        {
          id: 'collectibles-testimonials',
          type: 'testimonials',
          props: { title: 'Collector Reviews', mode: 'latest', count: 3 },
          visible: true,
        },
        {
          id: 'collectibles-tabs',
          type: 'store-tabs',
          props: { tabs: ['reviews', 'following', 'followers'] },
          visible: true,
        },
  ...
  },
  {
    id: 'digital',
    name: 'Digital Goods',
    nameKey: 'admin.storeBranding.presetDigital',
    description: 'Instant-delivery storefront for software, keys and downloads',
    descriptionKey: 'admin.storeBranding.presetDigitalDesc',
    config: {
      version: 1,
      status: 'published',
      theme: {
      ...
      sections: [
        {
          ...
          type: 'announcement-bar',
          props: {
            text: 'Instant delivery — keys arrive right after payment confirms',
            dismissible: true,
          },
          visible: true,
        },
        {
          ...
          type: 'hero',
          props: {
            title: 'Pay. Download. Done.',
            subtitle: 'Software, licenses and digital assets with instant crypto checkout',
        ...
        },
        {
          ...
          props: {
            ...
            items: [
              {
                question: 'When do I receive my purchase?',
                answer: 'Downloads and keys unlock automatically once payment confirms on-chain.',
              },
              {
                question: 'What if a key does not work?',
                answer: 'Open a dispute within the protection window and escrow has your back.',
              },
            ],
          },
          visible: true,
  ...
  },
  {
    id: 'apparel',
    name: 'Apparel',
    nameKey: 'admin.storeBranding.presetApparel',
    description: 'Editorial, image-led layout for fashion and streetwear',
    descriptionKey: 'admin.storeBranding.presetApparelDesc',
    config: {
      version: 1,
      status: 'published',
      theme: {
      ...
      sections: [
        {
          ...
          props: {
            ...
            subtitle: 'Small-batch drops, shipped worldwide',
        ...
        },
        {
          ...
          type: 'collections',
          props: { title: 'Shop by Line', mode: 'all', layout: 'grid', columns: 3 },
          visible: true,
        },
        {
          id: 'apparel-featured',
          type: 'featured-products',
          props: { title: 'This Week', mode: 'newest', count: 6, columns: 3 },
          visible: true,
        },
        {
          id: 'apparel-gallery',
        ...
        },
        {
          ...
          props: {
            title: 'The Studio',
            text: 'Tell the story behind your label...',
            imagePosition: 'left',
            showContactInfo: true,
          },
          visible: true,
