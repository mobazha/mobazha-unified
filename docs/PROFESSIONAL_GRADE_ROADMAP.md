...
最后更新: 2026-02-26 (v21: PG-009 完成 — StoreHero 组件（店铺头像/名称/简介/位置/统计/搜索框），app/page.tsx 条件路由（standalone→StoreHero，SaaS→Hero），隐藏 Featured/Categories 区，Tier 0.5 全部完成)
