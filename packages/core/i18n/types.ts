...
export interface TranslationResource {
  ...
  dealCommissionStatements?: {
    ...
    disclosureBody?: string;
    manualReviewOnlyNotice?: string;
    disclosurePaymentSeller?: string;
    disclosurePaymentPromoter?: string;
    sellerControlsTitle?: string;
    sellerControlsBody?: string;
    sellerControlAcknowledge?: string;
    sellerControlDispute?: string;
    sellerControlRecordPayment?: string;
    sellerControlsUnavailable?: string;
    loading?: string;
    loadFailed?: string;
    retry?: string;
    refresh?: string;
    ...
    eligibilityDecisionLabel?: string;
    eligibilityDecisionDeferred?: string;
    eligibilityDecisionEligible?: string;
    eligibilityDecisionDisputed?: string;
    eligibilityDecisionReversed?: string;
    eligibilityReviewedAt?: string;
    eligibilityReasonsLabel?: string;
    eligibilityReasonUnknown?: string;
    eligibilityReason?: {
      review_hold_active?: string;
      order_not_terminal?: string;
      refund_observed?: string;
      dispute_history?: string;
      provider_dispute_open?: string;
      provider_dispute_outcome_unconfirmed?: string;
      provider_chargeback_observed?: string;
      test_order?: string;
      related_account?: string;
      automatic_identity_match?: string;
      already_disputed?: string;
