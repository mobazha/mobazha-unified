...
export interface TranslationResource {
  ...
  admin?: {
    ...
    dealLinks?: {
      ...
      dealEditTitle?: string;
      dealEditSubtitle?: string;
      dealEditCta?: string;
      dealEditSuccess?: string;
      dealEditFailed?: string;
      ...
      backToDealLinks?: string;
      expandDetails?: string;
      copyPromoterLink?: string;
      promoterLinkCopied?: string;
      ...
      programsFilterAll?: string;
      programsFilterActive?: string;
      programsFilterPaused?: string;
      programsFilterDraft?: string;
      programsFilterEmpty?: string;
      attributionFilterLabel?: string;
      attributionFilterAll?: string;
      attributionFilterRecorded?: string;
      attributionFilterPending?: string;
      attributionFilterNotEligible?: string;
      attributionFilterSettled?: string;
      attributionFilterDisputed?: string;
      attributionFilterEmpty?: string;
      attributionFilterCount?: string;
      onboarding?: {
        title?: string;
        step1?: string;
        step2?: string;
    ...
    storeBranding?: {
      ...
      exitPreview?: string;
      previewBannerDraft?: string;
      previewBannerLive?: string;
      publishConfirmTitle?: string;
      publishConfirmMessage?: string;
      publishConfirmAction?: string;
      changeFirstPublish?: string;
      changeTheme?: string;
      changeSectionsAdded?: string;
      changeSectionsRemoved?: string;
      changeSectionsUpdated?: string;
      changeSectionsReordered?: string;
      autoSaved?: string;
      pageColors?: string;
      ...
      contrastHintSetText?: string;
      roleBodyText?: string;
      rolePrimary?: string;
      rolePageBackground?: string;
      roleCardSurface?: string;
      brokenListingRefs?: string;
      brokenCollectionRefs?: string;
      sharePreview?: string;
      sharePreviewTitle?: string;
      sharePreviewDesc?: string;
      sharePreviewExpires?: string;
      sharePreviewRotate?: string;
      sharePreviewRotateHint?: string;
      sharePreviewFailed?: string;
      copyLink?: string;
      linkCopied?: string;
      versionHistory?: string;
      versionHistoryDesc?: string;
      versionHistoryEmpty?: string;
      versionHistoryMeta?: string;
      versionRestore?: string;
      versionRestored?: string;
      trustVerified?: string;
      trustEscrowUnmet?: string;
      trustCryptoUnmet?: string;
      fieldManualProducts?: string;
      selectProducts?: string;
      editProductSelection?: string;
      manualProductsHint?: string;
      noProductsFound?: string;
      noProductsYet?: string;
      goAddProducts?: string;
      missingProduct?: string;
      fieldManualCollections?: string;
      selectCollections?: string;
      editCollectionSelection?: string;
      searchCollections?: string;
      noCollectionsFound?: string;
      noCollectionsYet?: string;
      goAddCollections?: string;
      missingCollection?: string;
      collectionUnpublished?: string;
      pickerSelectedCount?: string;
      moveItemUp?: string;
      moveItemDown?: string;
      removeItem?: string;
      addBadge?: string;
      ...
      editorEmptyProducts?: string;
      editorEmptyManualProducts?: string;
      editorEmptyCollections?: string;
      editorEmptyManualCollections?: string;
      editorEmptyGallery?: string;
      presetElectronics?: string;
      presetElectronicsDesc?: string;
      presetCollectibles?: string;
      presetCollectiblesDesc?: string;
      presetDigital?: string;
      presetDigitalDesc?: string;
      presetApparel?: string;
      presetApparelDesc?: string;
      aiRewrite?: string;
      aiRewriting?: string;
      refine?: string;
      refining?: string;
  ...
  sellerAffiliate?: {
    ...
    commissionRate?: string;
    attributionWindow?: string;
    attributionWindowUnit?: string;
    attributionWindowHelp?: string;
    attributionWindowPresets?: string;
    unitDays?: string;
    unitHours?: string;
    unitMinutes?: string;
    unitSeconds?: string;
    ...
    copyPromoterInvite?: string;
    promoterInviteCopied?: string;
    copyInviteFailed?: string;
    supportedRails?: string;
    railsSummary?: string;
    railsReadyCount?: string;
    railsShow?: string;
    railsHide?: string;
    costPreviewTitle?: string;
    costPreviewBody?: string;
    costPreviewExample?: string;
    capabilitiesLoadFailed?: string;
    guestSupported?: string;
    noSupportedRails?: string;
    statementsLockedHint?: string;
    promoterLinks?: string;
    noPromoterLinks?: string;
    linksLoadFailed?: string;
    linkActive?: string;
    linkRevoked?: string;
    revokeLink?: string;
    confirmRevoke?: string;
    revokeFailed?: string;
    sellerStatementTitle?: string;
    promoterStatementTitle?: string;
    ...
    filterPromoterAll?: string;
    filterFrom?: string;
    filterTo?: string;
    filterNoMatches?: string;
    clearFilters?: string;
    earningsAttributedOrders?: string;
    reversalReason?: string;
    editSettings?: string;
    hideSettings?: string;
    summaryLinks?: string;
    noLinkActivity?: string;
    linkOrdersCount?: string;
    linkCreatedAt?: string;
    unsavedChanges?: string;
    railsHistoryNote?: string;
    detailAttributedAt?: string;
    detailBuyer?: string;
    detailBasis?: string;
    detailLines?: string;
