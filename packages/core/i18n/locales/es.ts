...
export const es: TranslationResource = {
  ...
  otc: {
    ...
    step: { selectNft: 'Seleccionar NFT', setPrice: 'Establecer Precio', shareLink: 'Compartir Enlace' },
    status: { active: 'Activo', completed: 'Completado', cancelled: 'Cancelado' },
    price: 'Precio', priceDesc: 'El comprador pagará con USDT', shares: 'Acciones', totalPrice: 'Precio Total', platformFeeNote: '* Tarifa de plataforma del 5%', youWillReceive: 'Recibirás', selectNftDesc: 'Selecciona el NFT que deseas vender',
    creating: 'Creando...', purchasing: 'Comprando...', cancelling: 'Cancelando...', buyNow: 'Comprar Ahora', buyShares: 'Comprar Acciones', cancelOrder: 'Cancelar Orden', confirmCancel: '¿Estás seguro de cancelar esta orden?',
    createFailed: 'Error al crear orden', orderCreated: '¡Orden creada!', purchaseSuccess: '¡Compra exitosa!', purchaseFailed: 'Compra fallida', cancelSuccess: 'Orden cancelada', cancelFailed: 'Error al cancelar', orderNotFound: 'Orden no encontrada', transactionCompleted: 'Transacción completada', orderCancelled: 'Orden cancelada',
    shareText: '¡Estoy vendiendo un NFT privado, échale un vistazo!', shareToSell: 'Comparte el enlace con compradores potenciales', shareToTelegram: 'Compartir en Telegram', viewOrder: 'Ver Orden', createAnother: 'Crear otra orden',
    contractInfo: 'Info del Contrato', seller: 'Vendedor', network: 'Red', expectedRevenue: 'Ingresos Esperados', weeklyRevenue: 'Ingresos Semanales', annualizedRevenue: 'Ingresos Anuales', chatWithSeller: 'Chatear con Vendedor',
    connectWalletRequired: 'Por favor conecta tu billetera', connectWalletDesc: 'Conecta tu billetera para crear órdenes OTC', backToStore: 'Volver a Tienda',
    marketplaceOtcTitle: '🔐 Comercio OTC Privado', marketplaceOtcDesc: 'Listados privados de NFT y acciones RWA de miembros de la comunidad',
  },
