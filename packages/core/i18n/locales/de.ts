...
export const de: TranslationResource = {
  ...
  otc: {
    ...
    price: 'Preis', priceDesc: 'Der Käufer zahlt mit USDT', shares: 'Anteile', totalPrice: 'Gesamtpreis', platformFeeNote: '* 5% Plattformgebühr', youWillReceive: 'Sie erhalten', selectNftDesc: 'Wählen Sie das zu verkaufende NFT',
    creating: 'Wird erstellt...', purchasing: 'Kaufe...', cancelling: 'Wird storniert...', buyNow: 'Jetzt kaufen', buyShares: 'Anteile kaufen', cancelOrder: 'Stornieren', confirmCancel: 'Möchten Sie diesen Auftrag wirklich stornieren?',
    createFailed: 'Erstellung fehlgeschlagen', orderCreated: 'Auftrag erstellt!', purchaseSuccess: 'Kauf erfolgreich!', purchaseFailed: 'Kauf fehlgeschlagen', cancelSuccess: 'Auftrag storniert', cancelFailed: 'Stornierung fehlgeschlagen', orderNotFound: 'Auftrag nicht gefunden', transactionCompleted: 'Transaktion abgeschlossen', orderCancelled: 'Auftrag storniert',
    shareText: 'Ich verkaufe ein privates NFT, schau mal vorbei!', shareToSell: 'Teilen Sie den Link mit potenziellen Käufern', shareToTelegram: 'Auf Telegram teilen', viewOrder: 'Auftrag ansehen', createAnother: 'Weiteren erstellen',
    contractInfo: 'Vertraginfo', seller: 'Verkäufer', network: 'Netzwerk', expectedRevenue: 'Erwartete Einnahmen', weeklyRevenue: 'Wöchentliche Einnahmen', annualizedRevenue: 'Jährliche Einnahmen', chatWithSeller: 'Mit Verkäufer chatten',
    connectWalletRequired: 'Bitte verbinden Sie Ihre Wallet', connectWalletDesc: 'Verbinden Sie Ihre Wallet, um OTC-Aufträge zu erstellen', backToStore: 'Zurück zum Shop',
    marketplaceOtcTitle: '🔐 Privater OTC-Handel', marketplaceOtcDesc: 'Private NFT- und RWA-Anteile von Community-Mitgliedern',
  },
