...
export const de: TranslationResource = {
  ...
  listing: {
    ...
    wizard: {
      selectType: 'Produkttyp wählen',
      selectTypeDesc: 'Wählen Sie den Typ des Produkts, das Sie verkaufen möchten',
      selectAsset: 'Asset auswählen',
      selectAssetDesc: 'Aus vordefinierten Assets wählen',
      configureAsset: 'Asset konfigurieren',
      configureAssetDesc: 'Vertragsadresse und Parameter manuell eingeben',
      basicInfo: 'Grundinformationen',
      ...
      maxImages: 'Maximal 30 Bilder',
      videoSupport: 'YouTube/Vimeo-Links unterstützt',
      review: 'Überprüfen und veröffentlichen',
      reviewDesc: 'Bestätigen Sie die Richtigkeit der Informationen vor der Veröffentlichung',
