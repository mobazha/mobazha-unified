  ...
  deploy: {
    ...
    domain: {
      ...
      overlay: {
        ...
        tma: {
          title: 'Telegram Buyers Can Still Find You',
          desc: 'Even though your store runs on an overlay network, buyers using the Telegram Mini App can discover and browse your products through the Mobazha marketplace. The SaaS platform proxies requests to your store via LibP2P, so no direct network access is needed.',
          feature1: 'Store indexed in Mobazha marketplace search',
          feature2: 'Buyers browse via Telegram Mini App without overlay software',
          feature3: 'Orders and messages proxied through LibP2P peer network',
        },
