...
export const en: TranslationResource = {
  ...
  admin: {
    ...
    dealLinks: {
      ...
      manualReviewOnlyNotice:
        'Settlement is manual review only. Mobazha records attribution evidence but does not guarantee promoter payouts.',
      createTitle: 'Create promotion program',
      dealLinkLabel: 'Deal Link',
      dealLinkPlaceholder: 'Select a Deal Link',
      noDealLinks: 'Create a protected purchase link above before starting a promotion program.',
  ...
  dealPromotion: {
    ...
    attributionBannerBody:
      'Your price stays the same. Any partner reward is handled after your order is reviewed.',
    attributionWindowDays: 'Attribution window: {{count}} days',
    attributionWindowUnknown: 'Attribution window applies to this visit.',
    manualReviewOnlyNotice:
      'Any promoter compensation is subject to manual review. Acceptance does not guarantee earnings.',
  },

  promote: {
    title: 'Share this deal',
    subtitle: 'Use your personal link so eligible purchases can be credited to you.',
    disclosureTitle: 'How partner rewards work',
    disclosureBody:
      'When a buyer starts here and completes an eligible order, Mobazha records the purchase for reward review.',
    manualReviewOnlyNotice:
      'Rewards stay pending during refund and dispute checks. This MVP does not promise or send automatic payouts.',
    ...
    commissionRate: 'Potential reward',
    commissionValue: 'Up to {{percent}}%',
    attributionWindow: 'Buyer purchase window',
    windowDayValue: '{{count}} day',
    windowDaysValue: '{{count}} days',
    currency: 'Deal currency',
    commissionsLinkTitle: 'Reward activity',
    commissionsLinkBody:
      'See purchases credited to your links, their review status, and the earliest review date. Activity is not a withdrawable balance.',
    commissionsLinkCta: 'View reward activity',
    commissionsAuthRequired:
      'Sign in to view provisional commission observations for your promotions.',
  },

  dealCommissionStatements: {
    sellerTitle: 'Partner reward activity',
    sellerSubtitle:
      'Track purchases credited to your store’s active promotion links and their review status.',
    promoterTitle: 'Purchases credited to your links',
    promoterSubtitle: 'Track potential rewards and see what happens next.',
    promoterPageTitle: 'Reward activity',
    promoterPageSubtitle:
      'Track purchases started from your links, potential rewards, and review progress.',
    disclosureTitle: 'Rewards are confirmed after review',
    disclosureBody:
      'Amounts shown here are estimates, not a withdrawable balance. Refunds, disputes, and eligibility checks can change them.',
    manualReviewOnlyNotice:
      'Approved rewards are currently handled manually; payouts are not sent automatically.',
    loading: 'Loading reward activity…',
    loadFailed: 'Could not load reward activity.',
    retry: 'Try again',
    refresh: 'Refresh',
    empty:
      'No purchases have been credited to your links yet. Share your personal link to get started.',
    entryTitle: 'Order {{orderRef}}',
    observedAt: 'Observed {{date}}',
    proposedCommission: 'Potential reward',
    commissionBase: 'Eligible purchase amount',
    commissionRate: 'Rate',
    commissionRateValue: '{{percent}}%',
    settlementMode: 'Payout handling',
    settlementManualReview: 'Handled manually after approval',
    fundingSource: 'Reward funding',
    fundingSellerManualBudget: 'Funded by the seller',
    fundingUnknown: 'Funded by the promotion program',
    reviewNotBefore: 'Review can start after',
    reviewNotBeforeHint:
      'This is the end of the initial refund and dispute check, not a payout date.',
    reviewNotBeforeUnavailable: 'Not set',
    programRef: 'Program',
    dealLinkRef: 'Deal Link',
    statusObserved: 'Purchase recorded',
    statusPendingReview: 'Pending review',
    statusDisputed: 'On hold',
    statusReversed: 'Not eligible',
    statusSettled: 'Settled',
    statusObservedDescription:
      'The purchase was credited to your link and is in the waiting period.',
    statusPendingReviewDescription:
      'The waiting period has ended and the purchase is ready for review.',
    statusDisputedDescription: 'Review is paused while a dispute or payment issue is resolved.',
    statusReversedDescription: 'This purchase did not pass the reward eligibility checks.',
    statusSettledDescription: 'A completed manual settlement was recorded for this reward.',
    detailsCta: 'View calculation and references',
    statusUnknown: '{{status}}',
    eligibilityAuditTitle: 'Eligibility review record',
    eligibilityAuditHint:
      'This audit record does not change the not-payable status or guarantee manual review.',
