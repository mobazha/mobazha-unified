  ...
  admin: {
    ...
    productImport: {
      ...
      workbench: {
        ...
        subtitle: '{{count}} product row(s) ready for review',
        ...
        createApproval: 'Review & create listing',
        ...
        selectedCount: '{{count}} selected',
        batchPrepare: 'Prepare approvals',
        batchApproveApply: 'Approve & apply',
        batchReject: 'Reject',
        batchPrepareSuccess: 'Prepared {{count}} row(s) for approval',
        batchApplySuccess: 'Applied {{count}} listing(s)',
        batchRejectSuccess: 'Rejected {{count}} row(s)',
