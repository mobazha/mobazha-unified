...
export const en: TranslationResource = {
  ...
  dealPromotion: {
    entryResolving: 'Preparing your referred offer…',
    entryRedirecting: 'Taking you to the deal…',
    attributionBannerTitle: 'You arrived through a partner link',
    ...
    attributionWindowDays: 'Attribution window: {{count}} days',
    attributionWindowUnknown: 'Attribution window applies to this visit.',
    manualReviewOnlyNotice:
      'Partner attribution amounts are provisional. Payouts, if any, are arranged outside Mobazha.',
  },

  promote: {
    title: 'Share this deal',
    subtitle: 'Use your personal link so eligible purchases can be attributed to you.',
    disclosureTitle: 'How partner attribution works',
    disclosureBody:
      'When a buyer starts here and completes an eligible order, Mobazha records a provisional attribution statement—not a withdrawable balance.',
    manualReviewOnlyNotice:
      'After the protection period, only exception cases enter platform review. Most records follow automated checks.',
    directLinkTitle: 'Your personal link',
    loadingLink: 'Preparing your link…',
    linkFailed: 'Could not load your promotion link.',
    retry: 'Try again',
    entryPathHint: 'Eligible purchases started from this link can be credited to you.',
    copyCta: 'Copy link',
    shareCta: 'Share',
    copySuccess: 'Link copied',
    copyFailed: 'Could not copy link',
    shareTitle: 'Mobazha deal promotion',
    shareText: 'Check out this private deal offer.',
    authRequired: 'Sign in to create or reuse your direct promotion link.',
    signInCta: 'Sign in to continue',
    invalidProgram: 'Promotion program not found.',
    commissionRate: 'Estimated commission',
    commissionValue: 'Up to {{percent}}%',
    attributionWindow: 'Buyer purchase window',
    windowDayValue: '{{count}} day',
    windowDaysValue: '{{count}} days',
    currency: 'Deal currency',
    commissionsLinkTitle: 'Attribution activity',
    commissionsLinkBody:
      'See provisional attribution records for purchases credited to your links. These are estimates—not a withdrawable balance.',
    commissionsLinkCta: 'View attribution activity',
    commissionsAuthRequired:
      'Sign in to view provisional attribution statements for your promotions.',
  },

  dealCommissionStatements: {
    sellerTitle: 'Partner attribution statements',
    sellerSubtitle:
      'Provisional records of purchases credited to your promotion links. Amounts are estimates, not payable balances.',
    promoterTitle: 'Attribution to your links',
    promoterSubtitle:
      'Provisional attribution records and estimated commission—not a withdrawable balance.',
    promoterPageTitle: 'Attribution activity',
    promoterPageSubtitle:
      'Track purchases credited to your links and how each attribution is progressing.',
    disclosureTitle: 'Provisional attribution only',
    disclosureBody:
      'Mobazha records attribution and estimated amounts. Refunds, disputes, and eligibility checks can change or reverse them.',
    manualReviewOnlyNotice:
      'After the protection period, only exception cases enter platform review. Most records follow automated checks.',
    disclosurePaymentSeller:
      'Paying promoters is arranged by you outside Mobazha. Nothing here authorizes or sends payment.',
    disclosurePaymentPromoter:
      'Payouts are arranged by the seller outside Mobazha. Nothing here guarantees payment.',
    sellerControlsTitle: 'Seller controls',
    sellerControlsBody:
      'You fund the promotion program. Phase 1 lets you review attribution statements here, while approval, disputes, and payment records are not yet active controls.',
    sellerControlAcknowledge: 'Acknowledge attribution',
    sellerControlDispute: 'Dispute attribution',
    sellerControlRecordPayment: 'Record external payment',
    sellerControlsUnavailable:
      'Coming after Gate 2/3: seller acknowledgement, attribution disputes, and reconciled payment evidence.',
    loading: 'Loading attribution statements…',
    loadFailed: 'Could not load attribution statements.',
    retry: 'Try again',
    refresh: 'Refresh',
    empty:
      'No purchases have been attributed to your links yet. Share your personal link to get started.',
    entryTitle: 'Order {{orderRef}}',
    observedAt: 'Observed {{date}}',
    proposedCommission: 'Estimated commission',
    commissionBase: 'Eligible purchase amount',
    commissionRate: 'Rate',
    commissionRateValue: '{{percent}}%',
    settlementMode: 'Ledger handling',
    settlementManualReview: 'Attribution ledger only (no auto-payout)',
    fundingSource: 'Declared funding',
    fundingSellerManualBudget: 'Funded by the seller',
    fundingUnknown: 'Funded by the promotion program',
    reviewNotBefore: 'Protection ends',
    reviewNotBeforeHint:
      'End of the refund and dispute protection period—not a payout date. Most records proceed automatically unless an exception is flagged.',
    reviewNotBeforeUnavailable: 'Not set',
    programRef: 'Program',
    dealLinkRef: 'Deal Link',
    statusObserved: 'In protection period',
    statusPendingReview: 'Platform review',
    statusDisputed: 'On hold',
    statusReversed: 'Not eligible',
    statusSettled: 'Confirmed on ledger',
    statusObservedDescription:
      'This purchase was attributed and is in the automatic protection period.',
    statusPendingReviewDescription:
      'Protection has ended and this record is in platform exception review. Most attributions do not require this step.',
    statusDisputedDescription:
      'Attribution is paused while a dispute or payment issue is resolved.',
    statusReversedDescription: 'This purchase did not pass the attribution eligibility checks.',
    statusSettledDescription:
      'A ledger confirmation was recorded. Payment to the promoter, if any, remains outside Mobazha.',
    detailsCta: 'View calculation and references',
    statusUnknown: '{{status}}',
    eligibilityAuditTitle: 'Eligibility review record',
    eligibilityAuditHint:
      'This audit record is evidence only. It does not authorize payout or change the not-payable status.',
    eligibilityDecisionLabel: 'Last decision',
    eligibilityDecisionDeferred: 'Deferred',
    eligibilityDecisionEligible: 'Eligible',
    eligibilityDecisionDisputed: 'Disputed',
    eligibilityDecisionReversed: 'Reversed',
    eligibilityReviewedAt: 'Reviewed {{date}}',
    eligibilityReasonsLabel: 'Reasons',
    eligibilityReasonUnknown: 'Other reason ({{reason}})',
    eligibilityReason: {
      review_hold_active: 'Review hold is still active',
      order_not_terminal: 'Order has not reached a terminal state',
      refund_observed: 'Refund observed on the order',
      dispute_history: 'Order has dispute history',
      provider_dispute_open: 'Payment provider dispute remains open',
      provider_dispute_outcome_unconfirmed: 'Payment provider dispute outcome is unconfirmed',
      provider_chargeback_observed: 'Payment provider chargeback observed',
      test_order: 'Test order excluded from eligibility',
      related_account: 'Related account linkage detected',
      automatic_identity_match: 'Automatic identity match applied',
      already_disputed: 'Commission already marked disputed',
      already_reversed: 'Commission already reversed',
    },
