...
export const en: TranslationResource = {
  ...
  admin: {
    ...
    workspace: {
      title: 'AI Workspace',
      subtitle: 'Opportunities and assistant chat in one place.',
      opportunitiesTitle: 'Opportunities',
      noOpportunities: 'All caught up',
      noOpportunitiesHint: 'No urgent tasks right now. Use the assistant below for help.',
      chatTitle: 'Assistant',
      ...
      valueSummary:
        'Ask about orders, products, and analytics — or use opportunity cards to jump into tasks.',
      cardActionGo: 'Go',
    ...
    ai: {
      ...
      tabs: {
        workspace: 'Workspace',
        workspaceHint: 'Daily assistant chat and store opportunity cards.',
        models: 'Models & Keys',
        ...
        connectHint: 'Advanced: connect external AI apps (Cursor, Claude, MCP) to your store.',
      },
    },
    checklist: {
