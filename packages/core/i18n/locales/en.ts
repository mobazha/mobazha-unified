...
export const en: TranslationResource = {
  ...
  order: {
    dealLink: {
      title: 'Protected link order',
      buyerBody:
        'The seller, item version, price, and delivery terms were locked when you accepted the link. Payment, delivery, and any issue are tracked on this order.',
      sellerBody:
        'The item version, price, and delivery terms were locked when the buyer accepted your link. Complete delivery and handle any issue from this order.',
      detailsCta: 'View protected-link reference',
  ...
  settings: {
    ...
    sidebar: {
      ...
      advanced: 'Advanced',
      marketplaceMemberships: 'Marketplace invitations',
    },
    refunds: {
    ...
    accessControl: {
      ...
      selectMarketplacePlaceholder: 'Select a marketplace',
      marketplaceAuthLoading: 'Loading your marketplace memberships...',
      marketplaceAuthNoEligible: 'No eligible marketplaces',
      marketplaceAuthNoEligibleDesc:
        'Join a native marketplace or accept an invitation before using marketplace authorization.',
      marketplaceAuthPendingInvitationsDesc:
        'You have pending marketplace invitations. Accept them to use those marketplaces here.',
      marketplaceAuthAcceptInvitationsLink: 'Manage marketplace memberships',
      marketplaceAuthHelper: 'Members of the selected marketplace can view products in this group.',
      currentCommunityMarketplace: 'Current community marketplace',
  ...
  marketplace: {
    ...
    detail: {
      ...
      sellerAdmissionSelfServeDisabled:
        'Seller self-service is currently unavailable. Contact the marketplace operator for access.',
      visitPublicSite: 'Visit marketplace site',
      accessTitle: 'Access & catalog',
      buyerAccessPolicy: 'Buyer access',
      sellerReviewMode: 'Seller review',
      catalogMode: 'Catalog',
      ...
      sellersTab: 'Sellers',
      aboutTab: 'About',
      featuredBannersTitle: 'Featured banners',
      featuredListingsTitle: 'Featured listings',
      allListingsTitle: 'All listings',
      featuredSellersTitle: 'Featured sellers',
      allSellersTitle: 'All sellers',
    ...
    sell: {
      ...
      marketBuyerAccessLabel: 'Buyer access',
      marketSellerEntryLabel: 'Seller entry',
      marketSellerReviewLabel: 'Seller review',
      ...
      autoApprovalNote:
        'Auto review: your application is approved immediately after you submit. Product groups are optional when the catalog is open.',
      reviewRequiredNote:
        'Manual review: your application stays pending until the marketplace operator reviews it.',
      ...
      reviewUpdatesSubtitle:
        'Track every seller-review decision for your store in this marketplace.',
      reviewUpdatesUnreadCount: '{{count}} unread',
      reviewUpdatesLoading: 'Loading review updates...',
      reviewUpdatesEmpty: 'No review updates yet.',
      reviewUpdatesLoadFailed: 'Failed to load review updates. Please try again.',
      reviewUpdatesTransition: '{{previous}} -> {{current}}',
      reviewUpdatesReason: 'Reason: {{reason}}',
      reviewUpdatesUnread: 'Unread',
      reviewUpdatesMarkRead: 'Mark as read',
      reviewUpdatesMarking: 'Marking...',
      reviewUpdatesMarkReadFailed: 'Failed to mark this update as read. Please try again.',
    ...
    enums: {
      ...
      buyerAccessMode: {
        open: 'Open to all buyers',
      },
      sellerReviewMode: {
        auto: 'Auto approve sellers',
        manual: 'Manual review required',
      },
      sellerEntryMode: {
        operatorInvited: 'Operator invited',
        sellerSelfServe: 'Seller self-serve',
      },
      domainKind: {
        subdomain: 'Subdomain',
    ...
    operator: {
      ...
      listSubtitle:
        'Manage brand, domains, publish status, and store admission. Orders, payments, and fulfillment stay with each store.',
      createCta: 'Create Marketplace',
      createDraftTitle: 'Create draft',
      namePlaceholder: 'Name (required)',
      verticalPlaceholder: 'Vertical, e.g. collectible',
      subdomainPlaceholder: 'Subdomain (optional)',
      createAndConfigure: 'Create and configure',
      domainCount: '{{count}} domain(s)',
      activeSectionTitle: 'Active marketplaces',
      archivedSectionTitle: 'Archived history',
      archivedSectionDesc: 'Archived marketplaces are read-only and no longer accept new stores.',
      emptyTitle: 'No marketplaces yet',
      emptyDesc: 'Create a draft first, then publish after you confirm the setup.',
      loadFailedTitle: 'Could not load marketplaces',
      loadFailedDesc: 'Please try again in a moment.',
      createFailedTitle: 'Could not create marketplace',
      backToConsole: 'Back to operator console',
      backToMarketplaceDetail: 'Back to marketplace detail',
      previewDraft: 'Preview draft',
      publishChanges: 'Publish changes',
      previewDraftNoticeTitle: 'Draft preview - not live',
      previewDraftNoticeDesc:
        'This page shows your current draft curation and branding. Buyers cannot see it until you publish.',
      previewLoadFailed: 'Could not load draft preview. Please retry.',
      previewMissingId: 'Missing marketplace id for draft preview.',
      previewBannersTitle: 'Curated banners',
      previewListingsTitle: 'Curated listings',
      previewSellersTitle: 'Curated sellers',
      previewEmptyBanners: 'No curated banners in this draft.',
      previewEmptyListings: 'No curated listings in this draft.',
      previewEmptySellers: 'No curated sellers in this draft.',
      tabs: {
        ariaLabel: 'Marketplace operator sections',
        overview: 'Overview',
        curation: 'Homepage curation',
        sellers: 'Sellers',
        settings: 'Settings',
      },
      overviewReadinessTitle: 'Status & readiness',
      overviewStatusLabel: 'Status',
      publish: 'Publish',
      publishSuccess: 'Marketplace published',
      publishFailedTitle: 'Could not publish',
      suspendMarketplace: 'Suspend marketplace',
      suspendMarketplaceSuccess: 'Marketplace suspended',
      suspendMarketplaceFailedTitle: 'Could not suspend marketplace',
      resumeMarketplace: 'Resume marketplace',
      resumeMarketplaceSuccess: 'Marketplace resumed',
      resumeMarketplaceFailedTitle: 'Could not resume marketplace',
      publishAndDomains: 'Publish & domains',
      launchChecklistTitle: 'Launch checklist',
      launchChecklistDomainReady: 'Verified domain is ready.',
      launchChecklistDomainMissing: 'Verify at least one domain before publishing.',
      launchChecklistSellerReady: 'At least one approved visible seller is ready.',
      launchChecklistSellerMissing:
        'Approve and make at least one seller visible before publishing.',
      launchChecklistSellerSelfServe:
        'Sellers can apply after launch; an initial seller is recommended but not required.',
      publishBlockedHint: 'Complete the required launch checklist items before publishing.',
      resumeBlockedHint:
        'Complete the required launch checklist items before resuming this marketplace.',
      shareTitle: 'Share your marketplace',
      shareDescription: 'Your marketplace is live. Copy a link to invite buyers and communities.',
      shareCopyLink: 'Copy link',
      shareCopyCommunity: 'Copy community link',
      shareCopySuccess: 'Link copied',
      shareCopyFailed: 'Copy failed — select and copy the link below manually',
      shareManualLabel: 'Copy this link manually',
      shareLoading: 'Preparing your link…',
      shareError: 'We could not load your share link. Please try again shortly.',
      buyerAccessMode: 'Buyer access',
      discoverability: 'Discoverability',
      catalogMode: 'Catalog',
      storeAdmission: 'Store admission',
      waitingCount: 'Awaiting action: {{count}}',
      approvedCount: 'Approved: {{count}}',
      inviteNotApproval:
        'An invitation is not approval. The store must accept before you can approve catalog access.',
      ...
      storeMemberships: 'Store memberships',
      applicationReviewWorkspace: 'Seller application review',
      filterAll: 'All',
      ...
      pendingFirstHint: 'Pending applications appear first.',
      noStoresMatchFilter: 'No stores match this filter.',
      ...
      reviewHistoryEmpty: 'No review decisions yet.',
      reviewHistoryTransition: '{{previous}} -> {{current}}',
      reviewHistoryBy: '{{date}} by {{actor}}',
      reviewHistoryReason: 'Reason: {{reason}}',
      reviewHistoryLoadFailed: 'Failed to load review history. Please try again.',
      reviewActorPrefix: 'User',
      reviewActorFallback: 'Operator',
      noStoresYet: 'No stores invited yet.',
      catalogVisible: 'Visible in catalog',
      approve: 'Approve',
      suspend: 'Suspend',
      resumeSeller: 'Resume seller',
      reject: 'Reject',
      approveConfirmTitle: 'Approve this application?',
      approveConfirmDesc: 'The store will gain seller access in this marketplace.',
      reasonDialogTitleReject: 'Reject application',
      reasonDialogTitleSuspend: 'Suspend seller',
      reasonDialogDesc: 'A clear reason is required. This message is visible to the seller.',
      reasonLabel: 'Reason',
      reasonPlaceholderReject: 'Explain why this application is rejected.',
      reasonPlaceholderSuspend: 'Explain why this seller access is suspended.',
      reasonRequired: 'Reason is required.',
      reasonLength: 'Reason must be 1000 characters or fewer.',
      reasonCharCount: '{{count}}/1000',
      submitReject: 'Reject with reason',
      submitSuspend: 'Suspend with reason',
      approveSuccess: 'Application approved',
      rejectSuccess: 'Application rejected',
      suspendSuccess: 'Seller suspended',
      reviewFailedTitle: 'Could not update membership',
      detailLoadFailed: 'Could not load this marketplace. Return to the list and try again.',
      noDescription: 'No positioning or buyer value proposition yet.',
      settingsTitle: 'Marketplace settings',
      settingsDesc:
        'Configure brand, access rules, catalog policy, and custom domains. DNS verification for custom domains happens after you save.',
      brandSectionTitle: 'Brand',
      accessSectionTitle: 'Access & catalog',
      domainsSectionTitle: 'Domains',
      nameLabel: 'Name',
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Describe who this marketplace is for and what buyers can expect',
      logoLabel: 'Logo URL',
      logoPlaceholder: 'https://… or /images/logo.png',
      bannerLabel: 'Banner URL',
      bannerPlaceholder: 'https://… or /images/banner.jpg',
      buyerAccessModeReadOnlyHint: 'Native marketplaces are open to all buyers.',
      catalogQueryLabel: 'Catalog query',
      catalogQueryPlaceholder: 'Optional filter expression for curated catalog scope',
      ...
      sellerReviewModeHint:
        'Auto review approves seller applications immediately. Manual review keeps applications pending until operator decision.',
      subdomainLabel: 'Subdomain',
      customDomainLabel: 'Custom domain',
      customDomainPlaceholder: 'e.g. shop.example.com',
      saveSettings: 'Save settings',
      discardChanges: 'Discard changes',
      validationNameRequired: 'Name is required.',
      validationVerticalRequired: 'Vertical is required.',
      validationInvalidHostname: 'Enter a valid hostname such as shop.example.com.',
      validationInvalidMediaUrl: 'Use an empty value, a path starting with /, or an http(s) URL.',
      saveSuccess: 'Marketplace settings saved',
      saveFailedTitle: 'Could not save settings',
      archiveAction: 'Archive marketplace',
      archiveTitle: 'Archive this marketplace?',
      archiveDescription:
        'Archived marketplaces become read-only and are hidden from public discovery. Store memberships are preserved but the marketplace no longer accepts changes.',
      archiveConfirm: 'Archive marketplace',
      ...
      curation: {
        ...
        loading: 'Loading curation...',
        loadFailed: 'Failed to load curation data. Please retry.',
        add: 'Add',
        addSuccess: 'Curated item added',
        addFailedTitle: 'Could not add curated item',
        reorderSuccess: 'Order updated',
        reorderFailedTitle: 'Could not update order',
        toggleSuccess: 'Status updated',
        toggleFailedTitle: 'Could not update status',
        removeSuccess: 'Curated item removed',
        removeFailedTitle: 'Could not remove curated item',
        empty: 'No curated items yet.',
        candidateCount: '{{count}} eligible candidates',
        candidatesLoadFailedTitle: 'Could not load curation candidates',
        searchCandidates: 'Search listing candidates',
        searchCandidatesPlaceholder: 'Search by listing slug or seller peer ID',
        search: 'Search',
        pageStatus: 'Page {{page}} of {{totalPage}} · {{total}} listings',
        previousPage: 'Previous candidate page',
        nextPage: 'Next candidate page',
        selectListing: 'Select a listing candidate',
        selectSeller: 'Select a seller candidate',
        selectBanner: 'Select a banner candidate',
        listingFallbackTitle: 'Untitled listing',
        sellerFallbackTitle: 'Seller',
        ...
        sections: {
          ...
          listingsDesc: 'Prioritized listing cards shown on homepage sections.',
          sellers: 'Featured sellers',
          sellersDesc: 'Sellers highlighted as curated storefronts.',
          banners: 'Banners',
          bannersDesc: 'Banner slots that promote selected listings.',
        },
      },
      readOnlyArchived: 'This marketplace is archived and read-only.',
    },
    memberships: {
      ...
      declineConfirmDesc: 'You can still be invited again later by the operator.',
      declineSuccess: 'Invitation declined',
      declineSuccessDesc: 'The invitation was declined and removed from active memberships.',
      declineFailedTitle: 'Could not decline invitation',
      leave: 'Leave marketplace',
      leaving: 'Leaving…',
      leaveConfirmTitle: 'Leave this marketplace?',
      leaveConfirmDesc:
        'You will lose seller access in this marketplace until invited or approved again.',
      leaveSuccess: 'Left marketplace',
      leaveSuccessDesc: 'Your membership was updated and access has been removed.',
      leaveFailedTitle: 'Could not leave marketplace',
      acceptSuccess: 'Invitation accepted',
      acceptSuccessDesc: 'The marketplace operator can now continue review.',
      acceptFailedTitle: 'Could not accept invitation',
      ...
      viewMarketplace: 'View marketplace',
      marketplaceUnavailable: 'Marketplace not publicly available',
      marketplaceUnavailableDesc:
        'Only published marketplaces have a public page. Draft, suspended, and archived marketplaces stay private.',
      activeSectionTitle: 'Current memberships',
      archivedSectionTitle: 'Archived history',
      reviewUpdates: 'Review updates',
      reviewHistory: 'Review history',
      reviewUpdatesUnreadBadge: '{{count}} unread',
      settingsCardTitle: 'Marketplace invitations',
      settingsCardDesc: 'Accept operator invitations to join curated marketplaces.',
    },
  },
  ...
  payment: {
    ...
    paymentProtection: 'Buyer protection',
    paymentProtectionInfo:
      'An independent protection provider can review order evidence and help resolve a problem between you and the seller.',
    protectFor: 'Protection for up to {{days}} days',
    selectModerator: 'Choose protection provider',
    selectModeratorDesc: 'Choose the independent provider for buyer protection',
    selectModeratorWarning: 'Choose a protection provider before continuing',
    ...
    selectionQuote: {
      title: 'Payment quote',
      hint: 'This locked quote sets your exact payment total until it expires.',
      paymentSubtotal: 'Payment subtotal',
      providerOrNetworkCost: 'Provider or network cost',
      platformPaymentCost: 'Platform payment cost',
      buyerPaymentTotal: 'Total to pay',
      conversionRate: 'Conversion rate',
      policyVersion: 'Pricing policy: {{version}}',
      expiresIn: 'Quote expires in {{minutes}}m {{seconds}}s',
      expired: 'Quote expired',
      provisioned: 'Quote locked to this payment session',
      requote: 'Refresh quote',
      errorTitle: 'Quote unavailable',
      errorHint: 'The payment quote could not be loaded. Refresh it before continuing.',
      blockedHint: 'Refresh the quote or choose another payment method to continue.',
    },
    subtotal: 'Subtotal',
    shipping: 'Shipping',
  ...
  userMenu: {
    ...
    myOrders: 'My Orders',
    myCases: 'My Cases',
    operatorMarketplaces: 'Marketplace operator',
    marketplaceInvitations: 'Marketplace invitations',
  ...
  notifications: {
    ...
    order: {
      ...
      ratedOrder: 'left a review for your order',
    ...
    messages: {
      ...
      orderRatedWithId: 'Buyer left a review for order #{{orderId}}',
      orderRatedNoId: 'Buyer left a review for your order',
  ...
  collectibles: {
    ...
    redeem: {
      ...
      connectWallet: 'Connect wallet',
      connecting: 'Connecting...',
      solanaWalletRequired: 'Connect a Solana wallet that holds this digital title.',
      shippingAddress: 'Shipping address',
    ...
    redemptions: {
      ...
      subtitle: 'Track physical card shipments after you redeem your digital titles.',
      empty: 'You have not redeemed any cards yet.',
    ...
    tracking: {
      ...
      loadFailed: 'Could not load redemption details. Try again later.',
      notFound: 'Redemption not found or you do not have access.',
      inProgressHint:
        'Your physical card will ship from the Hub after on-chain confirmation. Tracking appears here once dispatched.',
      phase: {
        redeem_requested: 'Preparing shipment from the Hub',
        shipped: 'Card shipped — track delivery below',
    ...
    hubOps: {
      title: 'Hub redemption ops',
      subtitle: 'Ship physical cards after on-chain burn. Hub operator access only.',
      redemptionId: 'Redemption ID',
      redemptionIdPlaceholder: 'Paste redemption ID from buyer flow',
      load: 'Load',
      loadFailed: 'Could not load redemption',
      fulfillmentTitle: 'Fulfillment',
      trackingPlaceholder: 'Carrier tracking number',
      ship: 'Mark shipped',
      settle: 'Mark settled',
      shipSuccess: 'Redemption marked as shipped',
      shipFailed: 'Could not mark as shipped',
      settleSuccess: 'Redemption settled',
      settleFailed: 'Could not settle redemption',
      viewBuyerTracking: 'Buyer tracking page',
      noActions: 'This redemption is already complete or not ready for Hub fulfillment.',
      mintRecoveryTitle: 'Pending mint recovery',
      mintRecoverySubtitle:
        'Recover minting slots that already submitted an on-chain mint transaction.',
      recoveryLimit: 'Limit',
      royaltyBps: 'Royalty bps',
      recoverMints: 'Recover mints',
      recoverSuccess: 'Mint recovery completed',
      recoverFailed: 'Could not recover pending mints',
      recovered: 'Recovered',
      skipped: 'Skipped',
      failed: 'Failed',
      attempted: 'Attempted',
      recentResults: 'Recent results',
      pendingRedemptionsTitle: 'Pending Hub redemptions',
      pendingRedemptionsSubtitle:
        'Redemptions awaiting shipment or settlement after on-chain burn.',
      refreshQueue: 'Refresh',
      queueLoadFailed: 'Could not load queue',
      queueEmpty: 'No items in this queue.',
      selectRedemption: 'Open',
      releaseQueueTitle: 'Primary sale release queue',
      releaseQueueSubtitle: 'Orders paid and received but escrow release or mint is still pending.',
      releaseRetry: 'Retry releases',
      releaseRetrySuccess: 'Release retry completed',
      releaseRetryFailed: 'Could not retry releases',
      releaseRetryReleased: 'Released',
      releaseStatus: 'Release status',
      orderId: 'Order ID',
      hubSlotStatus: 'Hub slot',
      releaseError: 'Last error',
      intakeTitle: 'Hub intake',
      intakeSubtitle:
        'Register a graded card after physical receipt. Mint only after intake is confirmed.',
      certNumber: 'Cert number',
      grade: 'Grade',
      serial: 'Serial',
      hubLocation: 'Hub location',
      currentHolder: 'NFT holder wallet',
      currentHolderPlaceholder: 'Solana wallet address',
      currentHolderHint:
        'Optional at intake. Required before mint — use the buyer wallet that should receive the NFT.',
      mintHolderDefault: 'Default mint holder',
      mintHolderDefaultHint:
        'Used when minting a slot that has no holder saved on intake (for example manual Hub ops).',
      mintHolderRequired:
        'Enter a holder wallet on intake or in the default mint holder field before minting.',
      submitIntake: 'Submit intake',
      intakeSuccess: 'Card intake recorded',
      intakeFailed: 'Could not record intake',
      slotsTitle: 'Hub slots',
      slotsSubtitle: 'Received cards awaiting mint or rejection.',
      slotStatus: 'Slot status',
      mint: 'Mint NFT',
      reject: 'Reject',
      mintSuccess: 'Mint submitted',
      mintFailed: 'Mint failed',
      rejectSuccess: 'Slot rejected',
      rejectFailed: 'Could not reject slot',
      alertReleaseFailed: 'Escrow release failed — retry from the release queue below.',
      alertMintPending: 'Mint recovery may be needed for slots stuck in minting.',
  ...
  ai: {
    ...
    goToSettings: 'Go to Settings',
    goToModels: 'Configure AI Models',
    ...
    approval: {
      ...
      reject: 'Reject',
      appliedTitle: 'Action applied',
      appliedDescription: '{{action}} completed successfully.',
      rejectedTitle: 'Action rejected',
      rejectedDescription: 'The AI request was rejected and will not run.',
      applyFailed: 'Could not apply the approved action.',
      rejectFailed: 'Could not reject the request.',
      statusApplied: 'Applied',
      statusRejected: 'Rejected',
      statusFailed: 'Apply failed',
      pendingBanner: '{{count}} pending approval(s)',
      actionBanner: '{{count}} approval(s) need your action',
      retry: 'Retry apply',
      viewInChat: 'Review in chat',
    },
  },
  ...
  admin: {
    ...
    dashboard: {
      ...
      supplyNeedsAttentionTitle: 'Supply needs attention',
      supplyNeedsAttentionCount: '{{count}} products need action',
      supplyNeedsAttentionViewAll: 'View all',
    },
    workspace: {
      title: 'AI Workspace',
      subtitle:
        'Store tasks on the left; the assistant drafts recommendations, imports, and checklists for your review.',
      opportunitiesTitle: 'Needs attention',
      opportunitiesShowMore: '{{count}} more',
      opportunitiesMobileCount: '{{count}} items',
      noOpportunities: 'All caught up',
      noOpportunitiesHint:
        "No urgent tasks right now. Import products, improve listings, or ask for today's focus.",
      chatTitle: 'Store assistant',
      chatAssistantTitle: 'Store assistant',
      chatAttachmentViewImage: 'View full image: {{name}}',
      chatAttachmentPreviewTitle: 'Attachment preview · {{name}}',
      layoutHideTasks: 'Hide tasks',
      ...
      badgeByok: 'Your AI keys',
      badgePlatform: 'Platform AI',
      badgeReady: 'AI ready',
      cardNoPayments: 'Set up payments',
      cardNoPaymentsDesc: 'Buyers cannot checkout until you add a payment method.',
      cardNoProducts: 'Add your first product',
      cardNoProductsDesc: 'Create a listing to start selling.',
      cardNoProductsOutcome: 'AI can turn materials into listing drafts for your review.',
      cardProductImport: 'Bulk import products',
      cardProductImportDesc:
        'Upload CSV or Excel, or paste messy text and supplier notes for AI cleanup.',
      cardProductImportOutcome:
        'Creates drafts and a review table. Nothing is listed automatically.',
      setupBannerTitle: 'Enable AI to use the assistant',
      setupBannerDesc:
        'Configure a model provider or platform AI to chat, optimize listings, and get store insights.',
      setupBannerCta: 'Configure AI Models',
      valueSummary:
        'Ask about orders, products, and analytics — or use task cards to draft recommendations and review checklists.',
      cardActionGo: 'Go',
      cardActionAsk: 'Ask assistant',
      cardActionHelp: 'Draft next steps',
      cardActionSuggest: 'Draft suggestions',
      cardActionDraft: 'Draft response',
      cardActionPlan: 'Build a plan',
      cardActionImport: 'Import and clean up',
      contextBarPrefix: 'Working on:',
      situationJoiner: ' · ',
      emptyPrimaryCta: 'Handle the most urgent first',
      emptyPrimaryCtaDefault: "Review today's focus",
      emptyPrimaryCtaSpecific: 'Draft next steps for {{count}} {{task}}',
      emptyPrimaryCtaSpecificTask: 'Draft next steps for {{task}}',
      composerPlaceholder: 'Ask anything, or paste/upload product data…',
      composerHint: 'Ask a question, paste text, or add an attachment.',
      composerDropHint: 'Release to add as attachment',
      composerFileDraftSummary: 'Added {{count}} file(s)',
      composerFileDraftHintChat:
        'Sent with your message. Say "import products" to organize listing drafts.',
      composerFileDraftRemove: 'Remove attachment',
      composerFileDraftMaxReached: 'You can add up to {{count}} files',
      composerFileDraftTotalSizeExceeded:
        'Attachments are too large in total. Remove some files before sending.',
      composerFileAttachedToChatTitle: 'Attachment added to chat',
      composerFileAttachedToChatDescription:
        'The assistant will use your message and attachment. No products are created automatically.',
      composerFileTooLargeForText: 'File is too large to attach. Try a smaller file.',
      composerFileChatDefaultSingle: 'Please answer using the attachment "{{name}}".',
      composerFileChatDefaultMultiple: 'Please answer using the attachments ({{names}}).',
      composerFileNameJoiner: ', ',
      composerUnsupportedFile: 'Unsupported file type. Use CSV, Excel, ZIP, images, or PDF.',
      composerSomeFilesSkipped: 'Some files were skipped because their type is not supported.',
      composerUpload: 'Upload product files',
      composerAttachReference: 'Attach as reference only',
      cardAskAi: 'Ask about your store',
      cardAskAiDesc: 'Get help with products, orders, or what to focus on next.',
      cardAskAiPrompt: 'What should I focus on in my store today?',
      cardPendingOrdersPrompt:
        'Summarize my pending orders and suggest which ones to handle first.',
      cardFulfillOrdersPrompt:
        'Which orders need fulfillment? List them by urgency with suggested next steps.',
      cardDisputedOrdersPrompt:
        'What disputes are open? For each one, suggest how I should respond.',
      cardSupplyAttentionPrompt:
        'Which products have low supply or need restocking? Give specific recommendations.',
      cardNoProductsPrompt:
        'I want to list my first products. Suggest an import approach and pricing tips for my store.',
      cardPendingOrdersOutcome: 'Summarizes priority and risks first. You approve order actions.',
      cardFulfillOrdersOutcome:
        'Builds a fulfillment order and missing-item check. No auto-fulfillment.',
      cardDisputedOrdersOutcome: 'Drafts response text. You confirm before anything is sent.',
      cardSupplyAttentionOutcome:
        'Suggests restock, pause, or replacement actions without changing inventory.',
      chatEmptyTitle: 'How can I help?',
      chatEmptyHint:
        'Pick a task on the left or ask below. AI drafts recommendations, imports, and checklists first.',
      quickActionImport: 'Import / clean products',
      quickActionImportPrompt:
        'I want to bulk-import products. My material may be CSV, Excel, product descriptions, or supplier notes. Help me turn it into reviewable listing drafts.',
      quickActionOrders: 'Review orders',
      quickActionOrdersPrompt: 'What orders need my attention right now?',
      quickActionFocus: "Today's focus",
      quickActionFocusPrompt: 'What should I focus on in my store today?',
      quickActionListings: 'Improve listings',
      quickActionListingsPrompt:
        'Review my product titles and descriptions and suggest improvements.',
      importRunTaskTitle: 'Product import',
      importRunTaskSummary: 'Parsed — {{count}} waiting for your review · {{status}}',
      importRunTaskParsing: '{{status}}',
      importRunContinueReview: 'Continue review',
      importRunSummary: '{{count}} to review · {{status}}',
      importRunStatusRunning: 'AI parsing',
      importRunStatusReview: 'Needs review',
      importRunStatusApproval: 'Needs approval',
      importRunStatusReady: 'Ready',
      importRunStatusChecking: 'Checking status',
      importRunStatusFailed: 'Failed',
      importRunStatusCancelled: 'Cancelled',
      importRunOpenWorkbench: 'Open workbench',
      sourceMaterialCompactPlaceholder: 'Paste CSV, product text, or supplier notes…',
      sourceMaterialImport: 'Import & review',
      sourceMaterialImportStartedTitle: 'Import started',
      sourceMaterialImportStartedDescription:
        'AI is parsing your material. Open the workbench from the status bar above.',
      sourceMaterialImportParsingTitle: 'Parsing material',
      sourceMaterialImportParsingDescription:
        'When parsing finishes, open the workbench from the status bar above. No products have been created yet.',
      sourceMaterialImportFailed: 'Could not start import. Check the format and try again.',
    ...
    ai: {
      models: {
        title: 'AI Models',
        subtitle: 'Choose your LLM provider, API keys, and enable AI features for your store.',
      },
      tabs: {
        workspace: 'Workspace',
        workspaceHint: 'Use AI in the browser for daily store work.',
        models: 'Models & Keys',
        modelsHint: 'Choose your LLM provider and API keys so AI features can run.',
        modelsPending: 'Setup required',
        settings: 'AI settings',
        connect: 'Connect clients',
        connectHint:
          'Connect Cursor, Claude, and other external tools to your store (MCP). Parallel to Workspace — pick the channel you use.',
    ...
    products: {
      createProtectedLink: 'Create protected link',
      title: 'Products',
      ...
      smartImport: 'Smart import (CSV / spreadsheet)',
      ...
      supplyModeExternal: 'Supplier fulfilled',
      supplyModeLicense: 'License codes',
      supplyModeInstant: 'Instant download',
      supplyModeTracked: 'Tracked stock',
      availabilityInstant: 'Instant available',
      availabilityBySupplier: 'By {{provider}}',
      availabilitySupplierGeneric: 'Supplier fulfilled',
      availabilityKeysLeft: '{{count}} keys left',
      availabilityImportKeys: 'Import license codes',
      availabilityAvailable: '{{count}} available',
      availabilityLowStock: 'Low stock · {{count}}',
      availabilityStockDetailed: '{{available}} available · {{onHand}} on hand · {{held}} held',
      availabilityStockDetailedLow:
        '{{available}} available · {{onHand}} on hand · {{held}} held · low stock',
      availabilityDash: '—',
      availabilityLoading: '…',
      summaryInstantReady: 'Instant download after payment',
      summaryMissingDigital: 'Complete digital delivery setup',
      summaryKeys: '{{available}} keys left · {{dispensed}} dispensed',
      summaryKeysHeld: '{{available}} keys left · {{held}} held for checkout',
      summaryKeysEmpty: 'Import license codes to keep selling',
      summaryStock: '{{count}} available',
      summaryStockLow: '{{count}} available · low stock',
      summaryStockOnHand: '{{available}} available · {{onHand}} on hand',
      summaryStockOnHandLow: '{{available}} available · {{onHand}} on hand · low stock',
      summaryStockDetailed: '{{available}} available · {{onHand}} on hand · {{held}} held',
      summaryStockDetailedLow:
        '{{available}} available · {{onHand}} on hand · {{held}} held · low stock',
      summaryExternal: 'Fulfilled by {{provider}} · available',
      summarySupplierGeneric: 'Supplier fulfilled · available',
      summaryManualAction: 'Complete setup before selling',
      summarySupplierUnavailable: 'Supplier temporarily unavailable',
      ctaManageVariants: 'Manage variant stock',
      ctaImportKeys: 'Import license codes',
      ctaConfigureDigital: 'Configure digital delivery',
      ctaViewSourcing: 'View supplier',
      preview: 'Preview',
      edit: 'Edit',
      duplicate: 'Duplicate',
      delete: 'Delete',
      ...
      actionImportKeys: 'Import license codes',
      bulkRestockSelected: 'Restock ({{count}})',
      bulkImportSelected: 'Import codes ({{count}})',
      bulkRestockTitle: 'Bulk restock',
      bulkRestockDesc: 'Add units to every variant of the selected tracked-stock products.',
      bulkRestockQuantityLabel: 'Units to add',
      bulkRestockQuantityHint: 'The same amount is added to each variant SKU.',
      bulkRestockConfirm: 'Add {{quantity}} units to {{count}} products',
      bulkRestockSuccess: 'Added {{quantity}} units to {{count}} products',
      bulkRestockPartialFail: '{{count}} products could not be restocked',
      bulkImportTitle: 'Bulk import license codes',
      bulkImportDesc: 'Paste keys for each product. Keys are hashed at rest.',
      bulkImportPlaceholder: 'XXXX-XXXX-XXXX-XXXX\nYYYY-YYYY-YYYY-YYYY',
      bulkImportConfirm: 'Import {{count}} keys',
      bulkImportSuccess: 'Imported {{keys}} keys across {{products}} products',
      bulkImportPartialFail: '{{count}} products failed to import',
    },
    productImport: {
      backToProducts: 'Back to Products',
      title: 'Import products',
      subtitle:
        'Bring catalog data from spreadsheets or supplier files. Review each row before publishing.',
      standardTitle: 'Standard store package',
      standardDesc:
        'Full Mobazha export ZIP with images, shipping profiles, and collections — deterministic restore.',
      standardCta: 'Open package import',
      smartTitle: 'Smart import',
      smartDesc:
        'Upload CSV, Excel, or ZIP supplier files. AI maps columns and prepares draft listings.',
      uploadTitle: 'Upload supplier files',
      uploadHint: 'Up to 20 files, 2 MB each. We parse the first 25 rows for preview.',
      dropzone: 'Drop files here or click to browse',
      formats: 'CSV, XLSX, ZIP, TXT, JSON',
      uploading: 'Parsing files…',
      uploadCta: 'Analyze {{count}} file(s)',
      errors: {
        fileTooLarge: '{{name}} exceeds the 2 MB limit',
        uploadFailed: 'Could not parse the uploaded files',
      },
      workbench: {
        backToHub: 'Back to import',
        title: 'Import workbench',
        subtitle: '{{count}} product draft(s) prepared. Review the details before applying them.',
        sources: 'Source files',
        validationTitle: 'Parser notes',
        validationCount: '{{count}} note(s)',
        validationShowDetails: 'Show all',
        validationHideDetails: 'Hide',
        mobileToolbarRunning: 'Parsing files…',
        mobileToolbarReviewing: 'Review products',
        primaryApplyReadyMobile: 'Publish {{count}} ready',
        emptyRows: 'No product rows were extracted from these files.',
        missingRun: 'Import run not found.',
        loadFailed: 'Could not load the import workbench',
        createApproval: 'Start review',
        createApprovalFailed: 'Could not prepare listing approval',
        ...
        statusPendingApproval: 'Ready to apply',
        ...
        runStatusRunning: 'Processing',
        runStatusWaiting: 'Awaiting review',
        runStatusCompleted: 'Completed',
        runStatusFailed: 'Failed',
        runStatusCancelled: 'Cancelled',
        summaryReviewable: 'Reviewable',
        summaryActionable: 'Actionable',
        summaryApplied: 'Applied',
        summaryFailed: 'Failed',
        filterLabel: 'Filter products on this page',
        pageScopeHint: 'Filters, counts, and bulk actions apply to the current page.',
        progress: {
          label: 'Product import progress',
          parse: 'Parse files',
          review: 'Review products',
          apply: 'Apply to store',
        },
        selectAll: 'Select all rows on this page',
        selectRow: 'Select row',
        expandRow: 'Expand product details',
        collapseRow: 'Collapse product details',
        selectedCount: '{{count}} selected',
        batchPrepare: 'Prepare review',
        batchApproveApply: 'Confirm & apply',
        batchReject: 'Remove from import',
        batchPrepareSuccess: 'Prepared {{count}} row(s) for review',
        batchApplySuccess: 'Applied {{count}} listing(s)',
        batchApplyPartial: 'Applied {{applied}} listing(s); {{failed}} could not be applied.',
        batchRejectSuccess: 'Removed {{count}} row(s) from this import',
        batchNothingToPrepare: 'Selected rows already have approvals',
        batchNothingToApprove: 'Selected rows are not ready to approve and apply',
        batchNothingToReject: 'No pending approvals to reject in selection',
        noRowDetails: 'No extra details for this row',
        untitledProduct: 'Product title not detected',
        fieldsToConfirm: '{{count}} to confirm',
        notDetected: 'Not detected',
        descriptionLabel: 'Product description',
        noDescription: 'No product description was detected',
        reviewChecklist: 'Review checklist',
        fieldsComplete: 'Core product details detected',
        missingField: {
          title: 'Confirm product title',
          price: 'Add product price',
          quantity: 'Add inventory quantity',
        },
        missingFieldLabel: {
          title: 'Title',
          price: 'Price',
        ...
        rowMissingSummary: 'Still needed: {{fields}}',
        rowReadySummary: '{{price}} · Qty {{qty}}',
        appliedSummary: '{{count}} product(s) applied successfully.',
        assistantTitle: 'Smart checks',
        assistantProcessing: 'Parsing the source files and organizing product details.',
        assistantNeedsReview:
          '{{rows}} product(s) still need {{fieldsLabel}}. Confirm them before applying.',
        assistantReady:
          'Core details were detected for {{count}} product(s). They are ready for review.',
        assistantNextStep: 'Recommended next step',
        assistantCheckMissing: 'Fill in {{fields}} first.',
        assistantCheckRows: 'Expand each product and confirm its description and parser results.',
        assistantUnavailable: 'AI assistant not configured',
        assistantOpenChat: 'Ask the AI assistant',
        assistantCloseChat: 'Collapse AI chat',
        pagination: '{{from}}–{{to}} of {{total}}',
        filter: {
          all: 'All',
          needs_review: 'Needs review',
          pending_approval: 'Ready to apply',
          applied: 'Applied',
          approval_failed: 'Apply failed',
        },
        userFilter: {
          all: 'All',
          needs_fix: 'Needs details',
        ...
        summaryNeedsFix: '{{count}} need details',
        summaryReady: '{{count}} ready to publish',
        summaryAllClear: 'All products in this import are handled',
        primaryApplyReady: 'Publish {{count}} ready on this page',
        primaryGoFix: 'Complete details',
        singleRowApply: 'Publish to store',
        expandToFix: 'Complete details',
        fixDetailsTitle: 'Complete product details',
        fixDetailsHint: 'Fill in missing fields, save, then publish to your store.',
        fieldRequired: 'Required',
        fieldPlaceholderPrice: 'e.g. 29.99',
        fieldPlaceholderQty: 'e.g. 10',
        saveDraft: 'Save changes',
        saveDraftSuccess: 'Product details updated',
        saveDraftFailed: 'Could not save product details',
        missingDraftVersion: 'Refresh the import workbench before saving these changes.',
        invalidPrice: 'Enter a valid non-negative price with no extra decimal places.',
        invalidQuantity: 'Enter a valid non-negative whole-number quantity.',
        completeFieldsFirst: 'Selected products still have missing details',
        fixWithAi: 'Ask AI to fill in',
        imageSourceLabel: 'Image',
        previewUnavailable: 'Preview unavailable',
        assistantApplyReady: '{{count}} product(s) are complete and ready to publish.',
      },
    },
    gumroadImport: {
      backToProducts: 'Back to Products',
    ...
    dealLinks: {
      ...
      deliveryFixedService: 'Fixed-scope service',
      reviewDaysLabel: 'Buyer review period (days)',
      reviewDaysDigitalHint: 'Digital delivery requires at least 3 days.',
      reviewDaysServiceHint: 'Services require at least 7 days.',
      dealCreateCta: 'Create and activate link',
      dealCreateValidationError: 'Choose an eligible product and a valid buyer review period.',
      ...
      noteLabel: 'Deal note (optional)',
      notePlaceholder: 'A short note shown to whoever opens this link, e.g. what was agreed.',
      sharingNotice:
        'Anyone who has this link can buy at these terms until you pause it or it expires.',
      dealEditTitle: 'Edit protected link',
      dealEditSubtitle:
        'Saving publishes a new revision. Orders already placed keep the terms they were bought under.',
      dealEditCta: 'Save revision',
      dealEditSuccess: 'Saved a new revision',
      dealEditFailed: 'Could not save the revision',
      activeDealsTitle: 'Active protected links',
      allLinksTitle: 'All links',
      copyDealCta: 'Copy',
      openDealCta: 'Open',
      dealCopySuccess: 'Purchase link copied',
      dealCopyFailed: 'Clipboard access was blocked. Select the link below to copy it.',
      manualCopyLabel: 'Purchase link',
      showAllDeals: 'Show all {{count}} links',
      showFewerDeals: 'Show fewer links',
      ...
      noDealLinks: 'Create a protected purchase link before starting a promotion program.',
      programNameLabel: 'Program name',
      programNamePlaceholder: 'e.g. Creator referrals',
      commissionLabel: 'Commission rate (%)',
      maxCommissionLabel: 'Max commission (optional)',
      maxCommissionPlaceholder: 'Leave blank for no cap',
      windowDaysLabel: 'Attribution window (days)',
      createCta: 'Create program',
      createValidationError: 'Check the Deal Link, name, commission, and window fields.',
      createSuccess: 'Promotion program created',
      createFailed: 'Could not create promotion program',
      programsTitle: 'Promotion programs',
      refresh: 'Refresh',
      loadFailed: 'Could not load Deal Links or promotion programs',
      noPrograms: 'No promotion programs yet.',
      dealLinkMissing: 'Linked Deal Link unavailable',
      statusDraft: 'Draft',
      statusActive: 'Active',
      statusPaused: 'Paused',
      statusExpired: 'Expired',
      ...
      activateFailed: 'Could not activate program',
      pauseSuccess: 'Program paused',
      pauseFailed: 'Could not pause program',
      ...
      tabs: {
        ...
        linksHint:
          'Copy or open purchase links you have activated for fixed-price digital goods and services.',
        programsHint: 'Manage commission terms and share promoter entry links with partners.',
        attributionHint:
      ...
      backToDealLinks: 'Back to deal links',
      expandDetails: 'Details',
      copyPromoterLink: 'Copy',
      promoterLinkCopied: 'Promoter link copied',
      programSummaryLine: '{{commission}}% · {{days}} days · {{product}}',
      linksEmptyTitle: 'No protected links yet',
      linksEmptyDescription:
        'Create a link for a published digital product or service to start protected checkout.',
      editDealCta: 'Edit',
      pauseDealCta: 'Pause',
      reactivateDealCta: 'Reactivate',
      activateDraftCta: 'Enable',
      closeDealCta: 'Close',
      createdLabel: 'Created',
      dealExpiresLabel: 'Expires',
      noExpiryLabel: 'No expiry',
      dealPauseSuccess: 'Link paused',
      dealPauseFailed: 'Could not pause the link',
      dealReactivateSuccess: 'Link reactivated',
      dealReactivateFailed: 'Could not reactivate the link',
      draftSavedActivateFailed:
        'Draft saved, but enabling it failed. Edit the draft or retry enabling it from the list.',
      dealCloseSuccess: 'Link closed',
      dealCloseFailed: 'Could not close the link',
      closeConfirmTitle: 'Close this protected link?',
      closeConfirmBody:
        'Once closed, buyers can no longer purchase through this link and the action cannot be undone. Existing order history is retained and stays viewable.',
      closeConfirmCta: 'Close link',
      viewOrdersCta: 'Orders',
      ordersTitle: 'Orders from this link',
      ordersSubtitle: 'Orders buyers placed through this protected purchase link.',
      ordersEmpty: 'No orders have been placed through this link yet.',
      ordersLoadFailed: 'Could not load this link’s orders',
      ordersCountLabel: '{{count}} orders',
      orderBuyerLabel: 'Buyer',
      orderOpenCta: 'View order',
      orderStatusCompleted: 'Order created',
      orderStatusProcessing: 'Processing',
      orderStatusManualReview: 'In review',
      orderStatusFailed: 'Failed',
      ordersStatusNote:
        'Status here reflects whether the protected link successfully created an order — not that it was paid, shipped, or fulfilled.',
      ordersRangeLabel: '{{from}}–{{to}} of {{total}}',
      ordersPrevPage: 'Previous',
      ordersNextPage: 'Next',
      programsEmptyTitle: 'No promotion programs yet',
      programsEmptyDescription:
        'Create a program to let partners share your protected purchase link and track attribution.',
      programsFilterLabel: 'Filter programs by status',
      programsFilterAll: 'All',
      programsFilterActive: 'Active',
      programsFilterPaused: 'Paused',
      programsFilterDraft: 'Draft',
      programsFilterEmpty: 'No programs match this filter.',
      attributionFilterLabel: 'Filter attribution by status',
      attributionFilterAll: 'All',
      attributionFilterRecorded: 'In protection period',
      attributionFilterPending: 'Platform review',
      attributionFilterNotEligible: 'Not eligible',
      attributionFilterSettled: 'Confirmed on ledger',
      attributionFilterDisputed: 'On hold',
      attributionFilterEmpty: 'No attribution statements match this filter.',
      attributionFilterCount: '{{label}} ({{count}})',
      onboarding: {
        title: 'Getting started',
        step1: 'Create a protected link',
        step2: 'Start a promotion program',
        step3: 'Share with partners',
    ...
    settings: {
      ...
      integrationsDescNoAi: 'Notification channels, webhooks, and fulfillment providers',
      aiModelsCard: 'AI Models & Keys',
    ...
    integrations: {
      ...
      aiMovedBanner: 'AI model settings have moved to the sidebar under AI → Models.',
      aiMovedLink: 'Open AI Models',
      ...
      aiByokExpand: 'Use your own API key',
      unsavedChanges: 'Unsaved changes',
    ...
    storeBranding: {
      ...
      fieldManualProducts: 'Featured products',
      selectProducts: 'Select products',
      editProductSelection: 'Edit product selection',
      manualProductsHint: 'Pick the products to feature; drag to reorder.',
      noProductsFound: 'No matching products',
      noProductsYet: 'Your store has no products yet.',
      goAddProducts: 'Add products',
      missingProduct: 'Unavailable product',
      fieldManualCollections: 'Collections to show',
      selectCollections: 'Select collections',
      editCollectionSelection: 'Edit collection selection',
      searchCollections: 'Search collections…',
      noCollectionsFound: 'No matching collections',
      noCollectionsYet: 'You have no collections yet.',
      goAddCollections: 'Create a collection',
      missingCollection: 'Unavailable collection',
      collectionUnpublished: 'Unpublished',
      ...
      addImage: 'Add image',
      fieldIcon: 'Icon',
      fieldCustomIcon: 'Custom icon URL',
      fieldDescription: 'Description',
      fieldName: 'Name',
      fieldRating: 'Rating (1–5)',
      fieldImages: 'Images',
      fieldCaption: 'Caption',
      iconEscrow: 'Escrow protection',
      iconCrypto: 'Crypto payments',
      iconSelfHosted: 'Self-hosted',
      ...
      useImageUrl: 'Use image URL instead',
      fieldSectionName: 'Section name (optional)',
      undo: 'Undo',
      redo: 'Redo',
      saveDraft: 'Save draft',
      publish: 'Publish',
      publishSuccess: 'Published to your store',
      draftSaved: 'Draft saved — not visible to buyers yet',
      draftBadge: 'Unpublished draft',
      discardDraft: 'Discard draft',
      discardDraftTitle: 'Discard this draft?',
      discardDraftMessage: 'Your unpublished changes will be deleted. The live store stays as is.',
      editorEmptyProducts: 'No products yet — this section will fill in once you add products.',
      editorEmptyManualProducts:
        'No products selected. Open this section in the left panel and pick products to feature.',
      editorEmptyCollections:
        'No published collections yet — this section will fill in once you publish one.',
      editorEmptyManualCollections:
        'No collections selected. Open this section in the left panel and pick collections.',
      editorEmptyGallery: 'No images yet. Open this section in the left panel and add images.',
      presetElectronics: 'Tech & Gadgets',
      presetElectronicsDesc: 'Bold, spec-forward layout for electronics and hardware',
      presetCollectibles: 'Collectibles',
      presetCollectiblesDesc: 'Showcase-first layout for cards, figures and rare finds',
      presetDigital: 'Digital Goods',
      presetDigitalDesc: 'Instant-delivery storefront for software, keys and downloads',
      presetApparel: 'Apparel',
      presetApparelDesc: 'Editorial, image-led layout for fashion and streetwear',
      aiRewrite: 'Rewrite with AI',
      aiRewriting: 'Rewriting…',
      refine: 'Refine',
      refining: 'Applying your tweaks…',
      refinePlaceholder: 'Tell the AI what to change, e.g. "warmer colors, shorter headline"',
      ...
      aiNotConfiguredDesc: 'Configure your AI provider in AI Models',
      ...
      resetClassicMessage:
        'This will remove all custom sections and restore the original store layout. The change goes to your draft and can be undone — buyers only see it once you publish.',
      ...
      previewBannerDraft: 'Draft preview · buyers still see the published version',
      previewBannerLive: 'Previewing your published store',
      publishConfirmTitle: 'Publish to your live store?',
      publishConfirmMessage: 'Buyers will see these changes immediately:',
      publishConfirmAction: 'Publish',
      changeFirstPublish: 'First publish of your custom storefront',
      changeTheme: 'Theme updated',
      changeSectionsAdded: 'Added {{count}} section(s)',
      changeSectionsRemoved: 'Removed {{count}} section(s)',
      changeSectionsUpdated: 'Updated {{count}} section(s)',
      changeSectionsReordered: 'Sections reordered',
      autoSaved: 'Auto-saved',
      pageColors: 'Page colors (optional)',
      pageBackground: 'Page background',
      bodyText: 'Body text',
      cardSurface: 'Card background',
      useDefault: 'Default',
      clearColor: 'Reset to default',
      contrastWarning: '{{fg}} on {{bg}} is only {{ratio}}:1 — below the 4.5:1 readability floor',
      contrastHintSetText:
        'The page background is dark; the default body text may be unreadable. Set a body text color.',
      roleBodyText: 'Body text',
      rolePrimary: 'Primary color',
      rolePageBackground: 'Page background',
      roleCardSurface: 'Card background',
      brokenListingRefs: '"{{section}}" references {{count}} product(s) that no longer exist',
      brokenCollectionRefs: '"{{section}}" references {{count}} collection(s) that no longer exist',
      sharePreview: 'Share preview',
      sharePreviewTitle: 'Share draft preview',
      sharePreviewDesc:
        'Anyone with this link can view your unpublished draft. Buyers still see the published store.',
      sharePreviewExpires: 'Link valid until {{date}}',
      sharePreviewRotate: 'Generate new link',
      sharePreviewRotateHint: 'Generating a new link invalidates the old one',
      sharePreviewFailed: 'Could not create the preview link.',
      copyLink: 'Copy',
      linkCopied: 'Copied',
      versionHistory: 'Version history',
      versionHistoryDesc:
        'Every publish archives the previous version. Restoring loads it into the editor as a draft — nothing changes for buyers until you publish.',
      versionHistoryEmpty: 'No previous versions yet — they appear after your next publish.',
      versionHistoryMeta: '{{count}} sections',
      versionRestore: 'Restore',
      versionRestored: 'Version loaded into the editor — publish to make it live',
      trustVerified: 'Verified',
      trustEscrowUnmet:
        'No moderators in your published store policy — buyers will not see this badge.',
      trustCryptoUnmet:
        'Your profile lists no accepted currencies — buyers will not see this badge.',
    },
  },
  ...
  store: {
    draftPreviewBanner: 'Draft preview — this is not the published store',
  ...
  dealLink: {
    storeIdPrefix: 'Store',
    pageEyebrow: 'Exclusive offer',
    loading: 'Loading your deal…',
    notFoundTitle: 'Deal link not found',
    notFoundDescription: 'This link may be invalid or no longer available.',
    expiredTitle: 'This deal has expired',
    expiredDescription: 'Ask the seller for a fresh link if you still want to buy.',
    inactiveTitle: 'This deal is not available',
    inactiveDescription: 'The seller paused or deactivated this offer.',
    errorTitle: 'Unable to load deal',
    errorDescription: 'Something went wrong while loading this deal. Try again in a moment.',
    networkErrorTitle: 'Connection problem',
    networkErrorDescription: 'We could not reach the server. Check your connection and retry.',
    quoteErrorTitle: 'Quote unavailable',
    quoteErrorDescription: 'We could not prepare a price quote. Refresh to try again.',
    retry: 'Try again',
    sellerFallback: 'Seller',
    productImageAlt: 'Photo of {{product}}',
    acceptedPaymentsLabel: 'Seller accepts',
    acceptedPaymentsFallback: 'Payment options appear after you continue',
    termsTitle: 'Delivery & buyer protection',
    acceptanceWindow: 'Time to review delivery',
    protectionWindow: 'Buyer protection period',
    windowDays: '{{count}} days',
    windowUnavailable: 'Provided after you continue',
    termsDefault:
      'Continue to create a protected order. You can review delivery and confirm receipt within the protection period.',
    deliverables: 'What you receive',
    refundTerms: 'Refund terms',
    refund: {
      before_download: 'Refundable before the digital delivery is accessed',
    },
    feeBreakdownTitle: 'Price breakdown',
    feeBreakdownHint: 'This quote is locked until it expires.',
    feeLine: {
      itemOrServiceAmount: 'Item or service',
      buyerServiceCharge: 'Buyer service charge',
      paymentOrNetworkCost: 'Payment or network cost',
      taxOrExternalCost: 'Tax or external cost',
      discount: 'Discount',
    },
    buyerTotal: 'Total due',
    quoteExpiryLabel: 'Quote expires in',
    countdownExpired: 'Quote expired',
    countdownValue: '{{days}}d {{hours}}h {{minutes}}m {{seconds}}s',
    paymentNeutralTitle: 'Choose payment after you continue',
    paymentNeutralBody:
      'Continuing creates your order and takes you to the standard Mobazha payment page, where you can pick from the seller-supported payment methods available for this order.',
    acceptCta: 'Continue with buyer protection',
    acceptCtaMobile: 'Continue securely',
    accepting: 'Preparing your order…',
    acceptFailed: 'We could not continue with this order. Refresh the quote and try again.',
    authRequiredHint: 'Sign in only when you continue. Browsing this deal stays public.',
    sameCurrencyNotice:
      'This offer is quoted in a single currency. Payment methods may vary, but the total you pay stays in this currency.',
    deliveryType: {
      digital_file: 'Digital delivery',
      license_key: 'License key delivery',
      fixed_service: 'Fixed service',
      unknown: 'Custom delivery',
    },
  },
  ...
  sellerAffiliate: {
    ...
    adminSubtitle:
      'Configure one automatic storefront-wide referral program and review its order-backed statement.',
    programTitle: 'Program settings',
    programDescription:
      'One storefront-wide program. Referral attribution and commission status update automatically from verified orders.',
    status: 'Status',
    active: 'Active',
    paused: 'Paused',
    commissionRate: 'Commission rate',
    attributionWindow: 'Attribution window',
    attributionWindowUnit: 'Attribution window unit',
    attributionWindowHelp:
      'How long after a buyer opens a valid promoter link that promoter can receive credit for the buyer’s order. A later order earns no commission after this window expires.',
    attributionWindowPresets: 'Suggested:',
    unitDays: 'Days',
    unitHours: 'Hours',
    unitMinutes: 'Minutes',
    unitSeconds: 'Seconds',
    ...
    invalidProgram:
      'Enter a commission from 0–100% and an attribution window from 1 minute to 365 days.',
    invalidRate: 'Commission must be greater than 0 and at most 100.',
    invalidWindow: 'Attribution window must be from 1 minute to 365 days.',
    pausedHint:
    ...
    promoterInviteCopied: 'Invite copied',
    copyInviteFailed: 'Unable to copy the promoter invite.',
    supportedRails: 'Automatic promoter payouts',
    railsSummary:
      'Payout methods available for new orders right now — payouts settle automatically, nothing to configure.',
    railsHistoryNote:
      'Commissions from earlier orders keep settling on the method captured with that order, even if it is not listed here.',
    railsReadyCount: '{{count}} payout methods ready',
    railsShow: 'View payout methods',
    railsHide: 'Hide payout methods',
    costPreviewTitle: 'What each sale costs you',
    costPreviewBody:
      'Commission is charged on an order’s net merchandise value — the product subtotal only. Shipping and tax are excluded, and if the order is refunded the matching commission is clawed back.',
    costPreviewExample:
      'At {{percent}}%, every 100 in net merchandise pays {{commission}} in commission.',
    capabilitiesLoadFailed: 'Unable to load automatic settlement capabilities.',
    guestSupported: 'Guest checkout',
    noSupportedRails: 'No complete affiliate settlement rail is currently available.',
    statementsLockedHint: 'Create the program above to start receiving commission statements.',
    promoterLinks: 'Promoter links',
    noPromoterLinks: 'No promoter has joined this program yet.',
    linksLoadFailed: 'Unable to load promoter links.',
    linkActive: 'Active',
    linkRevoked: 'Revoked',
    revokeLink: 'Revoke link',
    confirmRevoke: 'Confirm revoke',
    revokeFailed: 'Unable to revoke the promoter link.',
    ...
    paid: 'Paid',
    reversed: 'Reversed',
    clawbackDue: 'Clawback due',
    commission: 'Commission',
    settlementAmount: 'On-chain payment',
    settlementStatePlanned: 'Planned',
    settlementStateSubmitted: 'Submitted',
    settlementStateFailed: 'Automatic settlement failed. Review the reason and retry.',
    settlementStateAbandoned: 'Automatic settlement timed out. Review the reason and retry.',
    confirmations: '{{count}} confirmations',
    txHash: 'Transaction',
    confirmedAt: 'Confirmed {{time}}',
    copyTx: 'Copy transaction hash',
    copied: 'Copied',
    ...
    guestOrder: 'Guest',
    copyOrderID: 'Copy order ID',
    referralLabel: 'Referral session',
    copyReferral: 'Copy referral session ID',
    copyPromoter: 'Copy promoter Peer ID',
    filterAll: 'All',
    filterInProgress: 'In progress',
    filterPromoterAll: 'All promoters',
    filterFrom: 'From date',
    filterTo: 'To date',
    filterNoMatches: 'No commissions match the current filters.',
    clearFilters: 'Clear filters',
    earningsAttributedOrders: '{{count}} attributed orders',
    reversalReason: 'Reversal reason',
    editSettings: 'Edit settings',
    hideSettings: 'Hide settings',
    summaryLinks: '{{count}} promoter links',
    noLinkActivity: 'No attributed orders yet',
    linkOrdersCount: '{{count}} orders',
    linkCreatedAt: 'Created {{date}}',
    unsavedChanges: 'Unsaved changes',
    detailAttributedAt: 'Attributed',
    detailBuyer: 'Buyer',
    detailBasis: 'Commission basis',
    detailLines: '{{count}} order lines',
    settlementAddress: 'Payout address',
    copyAddress: 'Copy payout address',
    referralSaving: 'Saving your referral…',
    referralSaved: 'Referral saved',
    referralDescription:
      'Eligible purchases from this seller will be attributed automatically when you check out.',
    seller: 'Seller {{id}}',
  ...
  promote: {
    title: 'Promote this seller',
    subtitle: 'Use your personal link so eligible purchases are attributed automatically.',
    disclosureTitle: 'How seller affiliate works',
    disclosureBody:
      'When a buyer starts from your link and completes a verified order, the commission is automatically recorded and follows the order protection lifecycle.',
    directLinkTitle: 'Your personal link',
    loadingLink: 'Preparing your link…',
    linkFailed: 'Could not load your affiliate link.',
    retry: 'Try again',
    entryPathHint: 'Eligible purchases started from this link are attributed automatically.',
    copyCta: 'Copy link',
    shareCta: 'Share',
    copySuccess: 'Link copied',
    copyFailed: 'Could not copy link',
    shareTitle: 'Mobazha seller affiliate',
    shareText: 'Browse this seller through my referral link.',
    authRequired: 'Sign in to create or reuse your seller affiliate link.',
    signInCta: 'Sign in to continue',
    invalidProgram: 'Affiliate program not found.',
    ...
    commissionsLinkTitle: 'Affiliate earnings',
    commissionsLinkBody:
