...
export const en: TranslationResource = {
  ...
  admin: {
    ...
    dealLinks: {
      title: 'Deal Links & Promotion',
      subtitle: 'Run single-level direct promotion programs on your Deal Links.',
      ...
      noDealLinks: 'No Deal Links found. Create a Deal Link via API or backend tools first.',
  ...
  dealLink: {
    ...
    termsTitle: 'Terms & protection',
    acceptanceWindow: 'Acceptance window',
    protectionWindow: 'Buyer protection window',
    windowDays: '{{count}} days',
    windowUnavailable: 'Provided after acceptance',
    termsDefault: 'Complete acceptance to create a protected order with the quoted total.',
    ...
    paymentNeutralTitle: 'Choose payment after acceptance',
    paymentNeutralBody:
      'Accepting creates your order and takes you to the standard Mobazha payment page, where you can pick from the seller-supported payment methods available for this order.',
    acceptCta: 'Accept deal & continue',
    accepting: 'Creating order…',
    acceptFailed: 'We could not accept this deal. Refresh the quote and try again.',
    authRequiredHint: 'Sign in only when you accept. Browsing this deal stays public.',
    sameCurrencyNotice:
      'This offer is quoted in a single currency. Payment methods may vary, but the accepted total stays in this currency.',
    deliveryType: {
  ...
  dealPromotion: {
    ...
    attributionBannerTitle: 'Referred offer',
    attributionBannerBody:
      'This visit may be attributed to a promoter at up to {{commission}}% of the order in {{currency}}.',
  ...
  promote: {
    title: 'Your promotion link',
    subtitle: 'Create or reuse your direct link for this program.',
    disclosureTitle: 'Pilot promotion program',
    disclosureBody:
      'Share your link with buyers. If they accept the deal, attribution evidence may be recorded for manual review.',
    manualReviewOnlyNotice:
      'This pilot does not show balances, guaranteed earnings, or automatic payouts.',
    directLinkTitle: 'Direct promotion link',
    loadingLink: 'Preparing your link…',
    linkFailed: 'Could not load your promotion link.',
    retry: 'Try again',
    entryPathHint: 'Buyers enter through {{path}} before reaching the deal.',
    copyCta: 'Copy link',
    shareCta: 'Share',
    ...
    commissionRate: 'Proposed commission',
