...
export const en: TranslationResource = {
  ...
  admin: {
    ...
    workspace: {
      ...
      composerHint:
        'Drag or upload CSV, Excel, ZIP, images, PDF, and more—or paste product text. AI drafts first; you confirm before changes.',
      composerDropHint: 'Drop to upload and organize',
