...
export const en: TranslationResource = {
  ...
  marketplace: {
    ...
    operator: {
      ...
      settingsDesc: 'Update positioning, discovery, catalog rules, and domains before publishing.',
      descriptionLabel: 'Description',
      ...
      domainRemovalUnavailable:
        'Removing an existing domain is not supported here yet. Restore the current value or enter a replacement.',
    },
    memberships: {
