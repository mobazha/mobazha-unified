...
export const ru: TranslationResource = {
  ...
  otc: {
    ...
    step: { selectNft: 'Выбрать NFT', setPrice: 'Установить цену', shareLink: 'Поделиться ссылкой' },
    status: { active: 'Активный', completed: 'Завершён', cancelled: 'Отменён' },
    price: 'Цена', priceDesc: 'Покупатель заплатит в USDT', shares: 'Акции', totalPrice: 'Общая цена', platformFeeNote: '* Комиссия платформы 5%', youWillReceive: 'Вы получите', selectNftDesc: 'Выберите NFT для продажи',
    creating: 'Создание...', purchasing: 'Покупка...', cancelling: 'Отмена...', buyNow: 'Купить сейчас', buyShares: 'Купить акции', cancelOrder: 'Отменить', confirmCancel: 'Вы уверены, что хотите отменить этот заказ?',
    createFailed: 'Ошибка создания', orderCreated: 'Заказ создан!', purchaseSuccess: 'Покупка успешна!', purchaseFailed: 'Ошибка покупки', cancelSuccess: 'Заказ отменён', cancelFailed: 'Ошибка отмены', orderNotFound: 'Заказ не найден', transactionCompleted: 'Транзакция завершена', orderCancelled: 'Заказ отменён',
    shareText: 'Я продаю приватный NFT, загляните!', shareToSell: 'Поделитесь ссылкой с потенциальными покупателями', shareToTelegram: 'Поделиться в Telegram', viewOrder: 'Посмотреть заказ', createAnother: 'Создать ещё',
    contractInfo: 'Инфо о контракте', seller: 'Продавец', network: 'Сеть', expectedRevenue: 'Ожидаемый доход', weeklyRevenue: 'Недельный доход', annualizedRevenue: 'Годовой доход', chatWithSeller: 'Написать продавцу',
    connectWalletRequired: 'Пожалуйста, подключите кошелёк', connectWalletDesc: 'Подключите кошелёк для создания OTC заказов', backToStore: 'Назад в магазин',
    marketplaceOtcTitle: '🔐 Приватная OTC Торговля', marketplaceOtcDesc: 'Приватные NFT и RWA акции от участников сообщества',
  },
