...
export const zh: TranslationResource = {
  ...
  trust: {
    ...
    statusBar: {
      stage1Title: '资金已保护',
      stage1Desc: '您的资金已安全锁定',
      stage2Title: '商品运输中',
      stage2Desc: '卖家已发货，等待您确认收货',
      stage3Title: '交易完成',
      stage3Desc: '资金已释放给卖家',
      disputeLabel: '争议处理中',
      orderClosed: '该订单已关闭。',
  ...
  shippingTemplates: {
    ...
    profileDomesticFree: '国内包邮',
    profileDomesticFreeDesc: '中国大陆免费，港澳台 ¥10',
    profileWorldwideStandard: '全球标准',
    profileWorldwideStandardDesc: '亚洲 ¥5，其余地区 ¥10',
    profileCustom: '自定义',
    profileCustomDesc: '从空白方案开始',
