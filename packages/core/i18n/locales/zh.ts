...
5. 争议：如果收到的商品与约定的规格不符，您可以在买家保障期内发起争议。`,
  ...
  admin: {
    ...
    settings: {
      ...
      salesChannels: '销售渠道',
      salesChannelsDesc: '店铺链接、Telegram Bot 和分发渠道',
      profile: '店铺资料',
    ...
    salesChannels: {
      title: '销售渠道',
      subtitle: '管理店铺链接、Telegram Bot 和分发渠道',
      storeLinksTitle: '店铺链接',
      storeLinksDesc: '可分享的店铺链接，适用于各平台',
      telegramLink: 'Telegram 链接',
      directLink: '直接链接',
      mobileDeepLink: '移动端深度链接',
      shortCode: '短代码',
      noLink: '尚未生成店铺链接',
      generateLink: '生成链接',
      regenerate: '重新生成',
      ...
      storeHandleTitle: '店铺网址',
      storeHandleDesc: '设置唯一标识，获取专属品牌子域名',
      handleLabel: '店铺标识',
      handlePlaceholder: 'my-store',
      handleSuffix: '.mymbz.org',
      handleHint: '小写字母、数字和连字符，3-32 个字符。',
      handleAvailable: '标识可用',
      handleTaken: '标识已被占用',
      handleInvalid: '标识格式无效',
      handleSaved: '店铺标识已保存',
      handleRemoved: '店铺标识已移除',
      handleSaveButton: '保存标识',
      handleRemoveButton: '移除',
      handleRemoveConfirmTitle: '移除店铺标识？',
      handleRemoveConfirmDesc:
        '你的品牌网址将立即停止工作。通过此网址访问的用户将无法再到达你的店铺。',
      handleCurrentUrl: '你的店铺网址',

      telegramBotTitle: 'Telegram Bot',
      telegramBotDesc: '连接自有 Bot，打造品牌化店铺体验',
      connected: '已连接',
      setupGuideTitle: '如何设置你的店铺 Bot',
      setupStep1: '在 Telegram 中打开 @BotFather',
      setupStep2: '发送 /newbot 并按照提示创建 Bot',
      setupStep3: '复制 BotFather 提供的 Bot Token',
      setupStep4: '将 Token 粘贴到下方并点击连接',
