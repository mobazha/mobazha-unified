...
export const zh: TranslationResource = {
  ...
  settingsExtended: {
    ...
    paymentAndShipping: '支付与配送',
    paymentAndShippingDesc: '管理接受的加密货币和配送方式',
  ...
  admin: {
    ...
    settings: {
      title: '设置',
      subtitle: '配置你的店铺和个人偏好',
      sectionPersonal: '个人与店铺',
      ...
      general: '通用设置',
      generalDesc: '语言、货币和显示偏好',
      account: '账号绑定',
      accountDesc: '绑定和管理登录方式',
      accessControl: '访问控制',
      accessControlDesc: '白名单、用户组和商品组',
      blocked: '屏蔽列表',
      blockedDesc: '管理屏蔽的用户和店铺',
      chatEncryption: '聊天加密',
      chatEncryptionDesc: '安全消息传递的加密密钥',
      payments: '收款设置',
      paymentsDesc: '加密货币收款地址和银行卡支付',
      advanced: '高级设置',
      advancedDesc: '数据管理、缓存和开发者选项',
      integrations: '集成管理',
      integrationsDesc: 'AI 助手、Telegram 通知和 Webhook',
    },
    integrations: {
      title: '集成管理',
      subtitle: '管理 AI 助手、通知和外部服务',
      tabNotifications: '通知',
      tabAI: 'AI 助手',
      channels: '通知渠道',
