...
5. 争议：如果收到的商品与约定的规格不符，您可以在买家保障期内发起争议。`,
  ...
  guestCheckout: {
    ...
    stepCoin: '支付方式',
    stepPay: '付款',
    anonymousBannerTitle: '你正在以访客身份结账',
    anonymousBannerSubtitle: '无需账号——直接使用加密货币支付。',
    anonymousLearnMore: '这意味着什么？',
    anonymousPointNoAccount: '无需注册或创建账号。',
    anonymousPointDirectPayment: '付款直接发给卖家——没有 Escrow 或买家保障。',
    anonymousPointEmailOptional: '邮箱为可选项，但建议填写以接收订单更新。',
    anonymousPointSaveLink: '下单后请保存订单链接——这是唯一的找回方式。',
