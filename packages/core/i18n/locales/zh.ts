...
export const zh: PartialTranslationResource = {
  ...
  moderator: {
    ...
    addToStore: '添加到店铺',
    addedToStore: '已添加到店铺',
    addToStoreBanner: '选择调解员并添加到店铺，买家即可在您的商品上使用买家保障。',
    directoryEmpty: '没有符合筛选条件的调解员，请调整搜索或筛选条件。',
    directoryEmptyHint:
      '目录展示平台认证调解员。在搜索框粘贴完整 Peer ID（以 12D3KooW 开头）可查找其他调解员。',
  ...
  settingsExtended: {
    ...
    storeModeratorsEmptyDesc: '添加可信的争议仲裁人，让买家在您的商品上可使用买家保障。',
    storeModeratorsLoadFailed: '无法加载店铺仲裁人，请重试。',
    moderatorAlreadyAdded: '该仲裁人已在列表中。',
    moderatorNotFound: '未找到该 ID 对应的资料，请核对 ID 或前往仲裁人目录浏览。',
    moderatorNotConfigured: '该用户未注册为争议调解员。',
    moderatorPreviewLoading: '正在查找调解员…',
    moderatorPeerIdFormatHint: '请使用完整 Peer ID（以 12D3KooW 开头），不要使用截断显示 ID。',
    profileUnavailable: '暂时无法获取该仲裁人的完整资料。',
