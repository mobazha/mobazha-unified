...
export const zh: TranslationResource = {
  ...
  nav: {
    ...
    viewCart: '查看购物车',
    openUserMenu: '打开用户菜单',
    productGroupsDesc: '将商品组织到分组中用于店铺展示。',
  },
  login: {
    title: 'Mobazha',
    subtitle: '去中心化市场',
  ...
  me: {
    ...
    registrationFailedDesc: '请检查网络后重试。',
  },
  product: {
    title: '标题',
    description: '描述',
  ...
  order: {
    ...
    dispute: {
      ...
      addEvidence: '添加证据图片',
      evidence: '证据（可选）',
      evidenceHint: '最多 {{maxImages}} 张图片，每张 {{maxSizeMb}} MB',
    },
    afterSaleDispute: {
  ...
  payment: {
    ...
    remaining: '剩余',
    tron: {
      insufficientGas: 'TRX 不足以支付网络费用（需要: {{required}}，余额: {{balance}}）',
      gasExplanation: 'TRX 用于支付 TRON 网络费用（能量）。请充值后重试。',
    },
  },
  filter: {
    filters: '筛选',
  ...
  settingsExtended: {
    ...
    deleteConfirmDesc: '此操作不可撤销。您的账号和数据将被永久删除。',
    installApp: '安装应用',
    installAppDesc: '将 Mobazha 添加到主屏幕以更快访问。',
...
5. 争议：如果收到的商品与约定的规格不符，您可以在买家保障期内发起争议。`,
    ...
    notFound: '商品不存在',
    descriptionPlaceholderShort: '描述您的商品...',
    productImage: '商品图片',
    productTypeHint: '从建议中选择或自行输入',
    save: '保存',
    tokenAddress: '代币地址',
    uploadFailed: '一个或多个图片上传失败。',
  },
  rwa: {
    ...
    purchase: {
      ...
      sellerNotOwner: '卖家不是代币所有者',
      sellerTokenNotApproved: '卖家未授权代币',
    },
    fulfill: {
      waitingBuyer: '等待买家授权',
  ...
  auth: {
    ...
    createAccount: '创建账号',
    createAccountPrompt: '创建免费账号以使用此功能。',
  },
  collections: {
    browseAll: '浏览所有集合',
    empty: '暂无集合',
