...
export const zh: TranslationResource = {
  ...
  saasHome: {
    ...
    valueProps: {
      ...
      cryptoNativeDescriptionCommunity: '支持 BTC、BCH、LTC 与透明 Zcash 链上结算',
    },
    featuredStores: {
      title: '精选店铺',
    ...
    stats: {
      ...
      utxoPayments: 'BTC · BCH · LTC · 透明 ZEC',
    },
    audience: {
      title: '为每一位卖家打造',
...
5. 争议：如果收到的商品与约定的规格不符，您可以在买家保障期内发起争议。`,
  ...
  admin: {
    ...
    checklist: {
      ...
      setupPaymentDescCommunity: '添加 Bitcoin、Bitcoin Cash、Litecoin 或透明 Zcash 收款地址',
      setupShipping: '配置物流',
    ...
    onboarding: {
      ...
      setupPaymentsDescCommunity: '添加 Bitcoin、Bitcoin Cash、Litecoin 或透明 Zcash 收款地址',
      ...
      featurePricingCommunity: 'Bitcoin 系列加密货币定价',
    ...
    settings: {
      ...
      paymentsDescCommunity: 'Bitcoin 系列收款地址（BTC、BCH、LTC、透明 ZEC）',
      integrations: '集成管理',
