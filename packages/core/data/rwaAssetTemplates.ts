...
export const predefinedAssets: Record<AssetTypeCode, PredefinedAsset[]> = {
  ...
  BROADWAY: [
    {
      ...
      name: '音乐剧《狮子王》票房份额',
      description: '经典音乐剧《狮子王》的票房收益分成，按持有份额获得票房分红',
      image: null,
      emoji: '🦁',
      balance: 10000,
      unit: '份',
  ...
  STARLIGHT: [
    {
      id: 'starlight-dreams',
      name: 'Starlight Dreams 星光之梦',
      description: '一部关于在不夜城追逐梦想的全新音乐剧',
      image: null,
      emoji: '⭐',
      balance: 55000,
      unit: '份',
      tokenStandard: 'ERC3525',
      contractAddress: '0x298EE8406231C9c3A125677054c27f2584477572',
      contractName: 'Starlight Stage',
      tokenId: '1',
      slotId: '1',
      typeName: '票房份额',
      performance: {
    ...
    },
    {
      ...
      name: 'Midnight in Manhattan 曼哈顿午夜',
      description: '一部扣人心弦的话剧，讲述1950年代纽约的爱与失落',
      image: null,
      emoji: '🌃',
      balance: 60000,
      unit: '份',
    ...
    {
      id: 'neon-nights',
      name: 'Neon Nights 霓虹之夜',
      description: '一部充满活力的摇滚音乐剧，致敬洛杉矶日落大道的精神',
      image: null,
      emoji: '🌆',
      balance: 54000,
      unit: '份',
      ...
      rights: ['票房收益分红', '原声专辑抢先听', '幕后参观机会', '演员见面会'],
    },
    {
      id: 'last-frontier',
      name: 'The Last Frontier 最后的边疆',
      description: '一个关于拓荒者与美国梦的史诗故事',
      image: null,
      emoji: '🏔️',
      balance: 100000,
      unit: '份',
    ...
    },
    {
      id: 'golden-gate',
      name: 'Golden Gate 金门',
      description: '一部温馨的音乐喜剧，故事发生在旧金山湾区',
      image: null,
      emoji: '🌉',
      balance: 42000,
      unit: '份',
      ...
      rights: ['票房收益分红', 'VIP 座位优先选择', '幕后参观机会', '流媒体授权收益'],
    },
  ],
  KPOP: [
    {
      ...
      image: '/assets/rwa-tokens/kpop-ptd-jimin.svg',
      emoji: '🃏',
      balance: 1000,
      unit: '张',
      tokenStandard: 'ERC1155',
      contractAddress: '0x88c0494427313acaD1e97B06Fa7F58544750aEA9',
      contractName: 'K-pop 收藏品',
      tokenId: '1',
      slotId: '',
      typeName: '演唱会小卡',
      membership: {
    ...
    },
    {
      ...
      image: '/assets/rwa-tokens/kpop-ytc-v.svg',
      emoji: '✨',
      balance: 500,
      unit: '张',
      tokenStandard: 'ERC1155',
    ...
    },
    {
      ...
      image: '/assets/rwa-tokens/kpop-mots-set.svg',
      emoji: '📦',
      balance: 300,
      unit: '套',
      tokenStandard: 'ERC1155',
    ...
    },
    {
      ...
      image: '/assets/rwa-tokens/kpop-army-membership.svg',
      emoji: '💳',
      balance: 10000,
      unit: '张',
      tokenStandard: 'ERC1155',
