...
/**
 * Recognize legacy transparent Zcash address families in historical data.
 *
 * ZEC is not an enabled Community Edition payment chain. This helper is kept
 * only so dormant compatibility views can validate records created by older
 * nodes without treating shielded or unified addresses as transparent ones.
 */
