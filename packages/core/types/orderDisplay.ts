...
export interface CancellationContext {
  ...
  reason?: string;
  /** Safe cancel / 链上退款 settlement 已 confirmed */
...
export interface DisplayOrder {
  ...
  isModerated?: boolean;
  /** Legacy backend settlement type, retained for read-only order compatibility. */
   ...
   * 已观测到至少一笔事件时存在。Phase EVM-Safe v0.3.0 §4.2 — 即使订单已
